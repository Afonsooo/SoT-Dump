...
struct UMediaSubtitleComponent : UActorComponent {
	...
	void SetMediaPlayer(struct UMediaPlayer* NewMediaPlayer); // Function RareMediaComponents.MediaSubtitleComponent.SetMediaPlayer // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x6522b0
	struct UMediaPlayer* GetMediaPlayer(); // Function RareMediaComponents.MediaSubtitleComponent.GetMediaPlayer // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x652280
};

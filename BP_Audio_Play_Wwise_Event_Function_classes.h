...
struct ABP_Audio_Play_Wwise_Event_Function_C : AActor {
	...
	void StopAudio(); // Function BP_Audio_Play_Wwise_Event_Function.BP_Audio_Play_Wwise_Event_Function_C.StopAudio // Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
	void PlayAudio(); // Function BP_Audio_Play_Wwise_Event_Function.BP_Audio_Play_Wwise_Event_Function_C.PlayAudio // Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
	void UserConstructionScript(); // Function BP_Audio_Play_Wwise_Event_Function.BP_Audio_Play_Wwise_Event_Function_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
};

...
struct FViewTargetTransitionParams {
	...
	char UnknownData_C_1 : 7; // 0x0c(0x01)
	char UnknownData_D[0x1b]; // 0x0d(0x1b)
};
...
struct FGPUSpriteResourceData {
	...
	char UnknownData_684[0x3d4]; // 0x684(0x3d4)
	char SpawnLocationValueSemantic[0x06]; // 0xa58(0x06)
	char UnknownData_A5E[0x2]; // 0xa5e(0x02)
};
...
struct FGPUSpriteEmitterInfo {
	...
	char bLockToOwnerAxis : 1; // 0x188(0x01)
	...
	char bGeneratesCollisionEvents : 1; // 0x189(0x01)
	char bHasSpawnEventModule : 1; // 0x189(0x01)
	char UnknownData_189_2 : 6; // 0x189(0x01)

...
struct UWwiseEvent : UObject {
	...
	bool IsAudible(struct FVector SoundPosition, struct FVector ListenerPos, float AttenuationScaler); // Function WwiseAudio.WwiseEvent.IsAudible // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x334d90
	float GetMaxAttenuation(); // Function WwiseAudio.WwiseEvent.GetMaxAttenuation // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x334d60
	char GetDurationType(); // Function WwiseAudio.WwiseEvent.GetDurationType // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x334d20
	float GetDurationMin(); // Function WwiseAudio.WwiseEvent.GetDurationMin // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x334cf0
	float GetDurationMax(); // Function WwiseAudio.WwiseEvent.GetDurationMax // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x334cc0
};

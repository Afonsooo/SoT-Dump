...
struct ACustomServerLocalisationService : AActor {
	...
	void OnRep_GenerateLocalisationData(); // Function CustomServerLocalisation.CustomServerLocalisationService.OnRep_GenerateLocalisationData // Final|Native|Private // @ game+0x4b1ab00
	void BeginPlay(); // Function CustomServerLocalisation.CustomServerLocalisationService.BeginPlay // Final|Native|Private // @ game+0x4b1aae0
};

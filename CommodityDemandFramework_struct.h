...
// ScriptStruct CommodityDemandFramework.RedeemCommodityTelemetryEvent
// Size: 0x18 (Inherited: 0x00)
struct FRedeemCommodityTelemetryEvent {
	struct FString Commodity; // 0x00(0x10)
	bool RedemptionSucceeded; // 0x10(0x01)

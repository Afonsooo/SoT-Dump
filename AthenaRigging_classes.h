...
struct UInstancedRopeComponent : UPrimitiveComponent {
	struct UStaticMesh* StaticMesh; // 0x5c8(0x08)
	struct TArray<struct FInstancedRopeParams> Ropes; // 0x5d0(0x10)
	int32_t ShadowLOD; // 0x5e0(0x04)
	char UnknownData_5EC[0xa4]; // 0x5ec(0xa4)

	void SetUnderwater(bool* Underwater); // Function AthenaRigging.InstancedRopeComponent.SetUnderwater // Final|Native|Public|BlueprintCallable // @ game+0x48e98b0
	void SetRopes(struct TArray<struct FInstancedRopeParams>* InRopes); // Function AthenaRigging.InstancedRopeComponent.SetRopes // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x48e9780
};
...
struct URiggingSystemComponent : USceneComponent {
	...
	void SetSocketLookupSource(struct AActor** InSocketSource); // Function AthenaRigging.RiggingSystemComponent.SetSocketLookupSource // Final|Native|Public|BlueprintCallable // @ game+0x48e9830
	int32_t ConvertLineToRopeIndex(struct FName* InLineGroupName, int32_t* InLineOffset); // Function AthenaRigging.RiggingSystemComponent.ConvertLineToRopeIndex // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x48e9560
};
...
struct URopeInterface : UInterface {
	...
	void SetRopeUVOffset(float* InUVOffset); // Function AthenaRigging.RopeInterface.SetRopeUVOffset // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x48e9700
	void SetRopeEndpoints(struct FVector* InWorldSpaceStart, struct FVector* InWorldSpaceEnd); // Function AthenaRigging.RopeInterface.SetRopeEndpoints // Native|Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x48e9620
};

...
struct AFakeShip : AActor {
	...
	void OnAttachedItemEndPlay(struct AActor* Actor); // Function Watercrafts.FakeShip.OnAttachedItemEndPlay // Final|Native|Private // @ game+0x48ce710
};
...
struct UItemProxyWatercraftTrackerComponent : UActorComponent {
	...
	void OnRep_CurrentWatercraft(struct AActor* PreviousWatercraft); // Function Watercrafts.ItemProxyWatercraftTrackerComponent.OnRep_CurrentWatercraft // Final|Native|Private // @ game+0x48ce810
	void OnCurrentWatercraftDestroyed(struct AActor* DestroyedWatercraft); // Function Watercrafts.ItemProxyWatercraftTrackerComponent.OnCurrentWatercraftDestroyed // Final|Native|Private // @ game+0x48ce790
};
...
struct AWatercraft : AActor {
	...
	void OnRigidBodyWake(struct FName InBoneName); // Function Watercrafts.Watercraft.OnRigidBodyWake // Final|Native|Protected // @ game+0x48cea20
	void OnRigidBodySleep(struct FName InBoneName); // Function Watercrafts.Watercraft.OnRigidBodySleep // Final|Native|Protected // @ game+0x48ce9a0
};

// Class Watercrafts.Rowboat
// Size: 0xac0 (Inherited: 0x730)
struct ARowboat : AWatercraft {
	char UnknownData_730[0x50]; // 0x730(0x50)
	struct UChildActorComponent* LeftSideClamberSpot; // 0x780(0x08)
	struct UChildActorComponent* RightSideClamberSpot; // 0x788(0x08)
	struct UChildActorComponent* ForceSpot; // 0x790(0x08)
	struct UChildActorComponent* Lantern; // 0x798(0x08)
	struct UChildActorComponent* RowingSeat; // 0x7a0(0x08)
	struct UChildActorComponent* StorageSeat; // 0x7a8(0x08)
	struct URowboatCustomizationLoadoutComponent* CustomizationLoadoutComponent; // 0x7b0(0x08)
	struct UShipLiveryComponent* LiveryComponent; // 0x7b8(0x08)
	struct UReplicatedShipPartCustomizationComponent* CustomizationComponent; // 0x7c0(0x08)
	struct URepairableComponent* RepairableComponent; // 0x7c8(0x08)
	struct FVector WaterExclusionOffset; // 0x7d0(0x0c)
	struct FCollisionProfileName OverrideMountedCollisionProfileName; // 0x7dc(0x08)
	char UnknownData_7E4[0x4]; // 0x7e4(0x04)
	struct UTetherCustomisationComponent* TetherCustomisationComponent; // 0x7e8(0x08)
	struct UHealthComponent* HealthComponent; // 0x7f0(0x08)
	struct UActorDamageableComponent* ActorDamageableComponent; // 0x7f8(0x08)
	struct URammableComponent* RammableComponent; // 0x800(0x08)
	struct UScrapeableComponent* ScrapeableComponent; // 0x808(0x08)
	struct URowboatAudioComponent* RowboatAudio; // 0x810(0x08)
	struct UBaseHullDragDynamicsDesc* HullDragDynamicsDesc; // 0x818(0x08)
	struct UBowSplashContainer* OarSplashContainer; // 0x820(0x08)
	struct UMountableComponent* MountableComponent; // 0x828(0x08)
	struct UActorActivationComponent* ActorActivationComponent; // 0x830(0x08)
	struct UCurveFloat* LinearDampingOverTimeWhileBeachedScalarCurve; // 0x838(0x08)
	struct UCurveFloat* AngularDampingOverTimeWhileBeachedScalarCurve; // 0x840(0x08)
	struct FRowboatDamageEffectData DamageEffectData; // 0x848(0x18)
	struct FRowboatStrainDamageData StrainDamageData; // 0x860(0x20)
	struct TArray<struct UChildActorComponent*> AlwaysEnabledInteractables; // 0x880(0x10)
	struct UShroudBreakerTrackerComponent* ShroudBreakerTrackerComponent; // 0x890(0x08)
	bool IsBeingLaunched; // 0x898(0x01)
	bool IsSinking; // 0x899(0x01)
	char UnknownData_89A[0x2]; // 0x89a(0x02)
	float MaxPushingAngle; // 0x89c(0x04)
	float CurrentStrainAmount; // 0x8a0(0x04)
	bool IsDocked; // 0x8a4(0x01)
	char UnknownData_8A5[0x1]; // 0x8a5(0x01)
	char CoverCollisionChannel; // 0x8a6(0x01)
	char UnknownData_8A7[0x1]; // 0x8a7(0x01)
	float UnderCoverCheckInterval; // 0x8a8(0x04)
	float UnderCoverHeight; // 0x8ac(0x04)
	struct TArray<struct FVector> RelativeUnderCoverProbeRoots; // 0x8b0(0x10)
	char TrackedActorType; // 0x8c0(0x01)
	char UnknownData_8C1[0x3]; // 0x8c1(0x03)
	float LightDamagedRepairTime; // 0x8c4(0x04)
	float ModerateDamagedRepairTime; // 0x8c8(0x04)
	float HeavyDamagedRepairTime; // 0x8cc(0x04)
	float LightDamagedHealthThreshold; // 0x8d0(0x04)
	float ModerateDamagedHealthThreshold; // 0x8d4(0x04)
	float HeavyDamagedHealthThreshold; // 0x8d8(0x04)
	struct FName PremountCollisionProfileName; // 0x8dc(0x08)
	char UnknownData_8E4[0x1dc]; // 0x8e4(0x1dc)

	void SetAlwaysEnabledInteractables(struct TArray<struct UChildActorComponent*> InAlwaysEnabledInteractables); // Function Watercrafts.Rowboat.SetAlwaysEnabledInteractables // Final|Native|Protected|HasOutParms|BlueprintCallable // @ game+0x48ced30
	void ReactToRepairableStateChanged(char InNewState, char InPreviousState, struct URepairableComponent* InRepairableComponent); // Function Watercrafts.Rowboat.ReactToRepairableStateChanged // Final|Native|Protected // @ game+0x48ceb20
	void OnRep_IsSinking(); // Function Watercrafts.Rowboat.OnRep_IsSinking // Final|Native|Private // @ game+0x48ce890
};
...
// Class Watercrafts.RowingSeatAdaptiveTriggerComponent
// Size: 0xd8 (Inherited: 0xd0)
struct URowingSeatAdaptiveTriggerComponent : UAdaptiveTriggerComponent {
	struct FAdaptiveTriggerEffectMode_Feedback BothTriggers_Row; // 0xd0(0x03)
...
struct UTaleQuestWatercraftFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	struct AWatercraft* GetFirstSpawnedWatercraft(); // Function Watercrafts.TaleQuestWatercraftFunctionLibrary.GetFirstSpawnedWatercraft // Final|Native|Public // @ game+0x48ce6e0
	void FilterPointsByDistanceFromWatercraft(float MinDistance, struct TArray<struct FOrientedPoint> Points); // Function Watercrafts.TaleQuestWatercraftFunctionLibrary.FilterPointsByDistanceFromWatercraft // Final|Native|Public|HasOutParms|Const // @ game+0x48ce5f0
};
...
struct UWatercraftBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct AWatercraft* SpawnWatercraft(struct UObject* WorldContextObject, struct UClass* WatercraftClass, struct FVector Location, struct FRotator Rotation); // Function Watercrafts.WatercraftBlueprintFunctionLibrary.SpawnWatercraft // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x48cede0
};
...
struct UWatercraftSpawnData : UItemSpawnData {
	struct UClass* WatercraftClass; // 0x68(0x20)
	struct URowboatLiveryPicker* LiveryPicker; // 0x88(0x08)
	float MinDistanceToNearestWatercraftInMetres; // 0x90(0x04)
	char UnknownData_94[0x4]; // 0x94(0x04)
};
...
struct UWatercraftTrackerComponent : UActorComponent {
	...
	void OnWatercraftDestroyed(struct AActor** WatercraftActor); // Function Watercrafts.WatercraftTrackerComponent.OnWatercraftDestroyed // Final|Native|Private // @ game+0x48ceaa0
};

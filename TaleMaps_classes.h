...
struct URegionIslandWayfinderSelectionStrategy : URegionIslandSelectionStrategyBase {
	struct TArray<char> IslandTypes; // 0x28(0x10)
	bool EnsureKeyIslandIsLarge; // 0x38(0x01)
	char UnknownData_39[0x3]; // 0x39(0x03)
	float StartingIslandMinDistanceFromKeyIsland; // 0x3c(0x04)
...
struct UTaleQuestCustomMapFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void UpdateStrikeThoughTextElement(struct FGuid* MapGuid, struct FGuid* ElementGuid, bool* StrikeThroughEnabled); // Function TaleMaps.TaleQuestCustomMapFunctionLibrary.UpdateStrikeThoughTextElement // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x5014f50
	void AddCustomMap(struct UCustomMapData** Data, struct FGuid* MapGuid); // Function TaleMaps.TaleQuestCustomMapFunctionLibrary.AddCustomMap // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x5014990
};
...
struct UTaleQuestTornMapFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void AddTornMap(struct FName* IslandName, int32_t* NumPieces, struct UTornMapParams** MapParams, float* MaskRotation, struct FGuid* OutMapId); // Function TaleMaps.TaleQuestTornMapFunctionLibrary.AddTornMap // Final|Native|Public|HasOutParms|HasDefaults|Const // @ game+0x5014ab0
};
...
struct UTaleQuestTriggerNamedChecklistEventStepDesc : UTaleQuestStepDesc {
	...
	struct TArray<struct FString> EventsSource(); // Function TaleMaps.TaleQuestTriggerNamedChecklistEventStepDesc.EventsSource // Final|Native|Private|Const // @ game+0x5014cf0
};

...
// Enum EmissaryLevel.EEmisaryCompanyActionType
enum class EEmisaryCompanyActionType : uint8_t {
	...
	CompletedTreasury,
	CookedDish,
	DiscoveredEventAthenaMessageInABottle,
	EEmisaryCompanyActionType_MAX,
};

// Enum EmissaryLevel.EEmisaryFactionActionType
...
struct FEmissaryLevelData {
	...
	struct UWeightedItemDescSpawnDataAsset* WonInBattleEmissaryFlotsamSpawnDataAsset; // 0x48(0x20)
...
// ScriptStruct EmissaryLevel.EmissaryMaxRankQuestProviderQuestOverrides
// Size: 0x20 (Inherited: 0x00)
struct FEmissaryMaxRankQuestProviderQuestOverrides {
	struct FFeatureFlag FeatureFlag; // 0x00(0x0c)
	char UnknownData_C[0x4]; // 0x0c(0x04)
	struct FStringAssetReference QuestDesc; // 0x10(0x10)
};
...
struct FEmissarySessionStartTelemetryEvent {
	...
	struct FGuid GuildId; // 0x1c(0x10)
};
...
// ScriptStruct EmissaryLevel.EmissaryFactionActionRewardBoostServiceEvent
...
// ScriptStruct EmissaryLevel.EmissaryGlobalActionRewardBoostServiceEvent
// Size: 0x18 (Inherited: 0x00)
...
// ScriptStruct EmissaryLevel.EmissaryCompanyActionRewardBoostServiceEvent
// Size: 0x1c (Inherited: 0x00)
...
// ScriptStruct EmissaryLevel.EmissaryGlobalActionRewardBoostEvent
// Size: 0x08 (Inherited: 0x00)
struct FEmissaryGlobalActionRewardBoostEvent {
	struct UClass* GameEventType; // 0x00(0x08)
};

// ScriptStruct EmissaryLevel.EmissaryNonQuestCompanyActionRewardBoostEvent
// Size: 0x01 (Inherited: 0x00)
struct FEmissaryNonQuestCompanyActionRewardBoostEvent {
	char CompanyActionType; // 0x00(0x01)
};

// ScriptStruct EmissaryLevel.EmissaryQuestCompanyActionRewardBoostEvent
// Size: 0x14 (Inherited: 0x00)
...
struct FEmissarySunkNetworkEvent : FNetworkEventStruct {
	...
	struct FGuid GuildId; // 0x20(0x10)
};
...
// ScriptStruct EmissaryLevel.UpdateGuildEmissaryValueForCompany
// Size: 0x34 (Inherited: 0x00)
struct FUpdateGuildEmissaryValueForCompany {
	struct FGuid GuildId; // 0x00(0x10)
	struct FName Company; // 0x10(0x08)
	struct FGuid AssociatedCrew; // 0x18(0x10)
	int32_t UpdateAmount; // 0x28(0x04)
	int32_t From; // 0x2c(0x04)
	int32_t To; // 0x30(0x04)
};
...
// ScriptStruct EmissaryLevel.EmissaryCompanyChangedEvent
// Size: 0x10 (Inherited: 0x00)
struct FEmissaryCompanyChangedEvent {
	char UnknownData_0[0x10]; // 0x00(0x10)
};

// ScriptStruct EmissaryLevel.EmissaryLedgerVisited
// Size: 0x10 (Inherited: 0x00)

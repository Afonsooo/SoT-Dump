...
struct ALostSandsRowboatGunpowderBarrel : AActor {
	...
	bool IsFuseEnabled(); // Function LostSands.LostSandsRowboatGunpowderBarrel.IsFuseEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4f73290
	bool IsExplosionAtGoldenSandsOutpost(struct FVector* InLocation); // Function LostSands.LostSandsRowboatGunpowderBarrel.IsExplosionAtGoldenSandsOutpost // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4f731f0
	void EnableFuse(); // Function LostSands.LostSandsRowboatGunpowderBarrel.EnableFuse // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x4f731d0
	void DisableFuse(); // Function LostSands.LostSandsRowboatGunpowderBarrel.DisableFuse // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x4f731b0
};

...
struct UWorldLocationPopUpComponent : USceneComponent {
	...
	void OnOverlapEnd(struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function WorldLocationPopUpFramework.WorldLocationPopUpComponent.OnOverlapEnd // Final|Native|Protected // @ game+0x5061c60
	void OnOverlapBegin(struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool FromSweep, struct FHitResult SweepResult); // Function WorldLocationPopUpFramework.WorldLocationPopUpComponent.OnOverlapBegin // Final|Native|Protected|HasOutParms // @ game+0x5061aa0
};

...
struct UAbandonedNoteClueDestinationContainerComponent : UActorComponent {
	...
	void OnRep_CurrentTitleText(); // Function LostShipmentsClueVariants.AbandonedNoteClueDestinationContainerComponent.OnRep_CurrentTitleText // Final|Native|Private // @ game+0x1a774a0
	void OnRep_CurrentClueDestination(); // Function LostShipmentsClueVariants.AbandonedNoteClueDestinationContainerComponent.OnRep_CurrentClueDestination // Final|Native|Private // @ game+0x1a77480
};
...
struct AAbandonedNoteWieldable : ASkeletalMeshWieldableItem {
	...
	struct UWieldableItemCanvasRenderingComponent* WieldableItemCanvasRenderingComponent; // 0x7f8(0x08)
	struct UAbandonedNoteWieldableRenderingComponent* AbandonedNoteRenderingComponent; // 0x800(0x08)
	struct UInventoryItemComponent* InventoryItemComponent; // 0x808(0x08)
	struct UUsableWieldableComponent* UsableWieldableComponent; // 0x810(0x08)
	char QuestMapIcon; // 0x818(0x01)
	char UnknownData_819[0x7]; // 0x819(0x07)
};
...
struct AClueSiteCircleMapWieldable : ARenderToTextureMapBase {
	struct UTexture2D* InventoryRadialBackgroundTexture; // 0x898(0x20)
	struct FMapRadialIconData MapRadialIconData; // 0x8b8(0x18)

	void OnRep_MapRadialIconData(); // Function LostShipmentsClueVariants.ClueSiteCircleMapWieldable.OnRep_MapRadialIconData // Final|Native|Private // @ game+0x1a774e0
};
...
struct UClueVariantsBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void GiveClueDescriptorToItem(struct AItemInfo* ItemInfo, struct UClueDescriptor* Clue); // Function LostShipmentsClueVariants.ClueVariantsBlueprintFunctionLibrary.GiveClueDescriptorToItem // Final|Native|Static|Public|BlueprintCallable // @ game+0x1a773d0
};
...
struct UCompositeClueDestinationDescriptor : UClueDestinationDescriptor {
	...
	void OnRep_DestinationInfo(); // Function LostShipmentsClueVariants.CompositeClueDestinationDescriptor.OnRep_DestinationInfo // Final|Native|Private // @ game+0x1a774c0
};
...
struct UGooseChaseClueBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct UClueDescriptor* CreateEndOfGooseChaseClue(); // Function LostShipmentsClueVariants.GooseChaseClueBlueprintFunctionLibrary.CreateEndOfGooseChaseClue // Final|Native|Static|Public|BlueprintCallable // @ game+0x1a77370
};
...
struct UTaleQuestClueInventoryService : UTaleQuestService {
	...
	void SetClueTitleText(struct FText InTitleText); // Function LostShipmentsClueVariants.TaleQuestClueInventoryService.SetClueTitleText // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x1a77500
	int32_t GetCollectedClueCount(); // Function LostShipmentsClueVariants.TaleQuestClueInventoryService.GetCollectedClueCount // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x1a773a0
};

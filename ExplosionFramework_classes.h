...
struct UFuseInterface : UInterface {
	...
	bool GetIsActive(); // Function ExplosionFramework.FuseInterface.GetIsActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4c27e20
};

// Class ExplosionFramework.StatusResponseCancelFuse
// Size: 0x30 (Inherited: 0x30)
struct UStatusResponseCancelFuse : UStatusResponse {
};
...
struct UTaleQuestFuseFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void TriggerFuse(struct AActor** InFuseActor); // Function ExplosionFramework.TaleQuestFuseFunctionLibrary.TriggerFuse // Final|Native|Static|Public // @ game+0x4c27e50
};

...
enum class EEQSLocationRequestState : uint8_t {
	...
	FailedNoQuery,
	FailedNoQueryOwner,
	FailedCouldNotExecuteQuery,
	FailedNoValidPos,
	EEQSLocationRequestState_MAX,
};
...
struct FAIBountySpawnerParams {
	...
	bool ConvertFinalCaptainToSkeletonLord; // 0xc8(0x01)
...
struct FAIFormVarietyEntry {
	struct FFeatureFlag FeatureFlag; // 0x00(0x0c)
	char UnknownData_C[0x4]; // 0x0c(0x04)
	struct FStringAssetReference Form; // 0x10(0x10)
	float Weight; // 0x20(0x04)
	int32_t MaxPerEncounter; // 0x24(0x04)
	struct TArray<struct FAIIndividualVarietyEntry> Individuals; // 0x28(0x10)
};
...
struct FAIIndividualVarietyEntry {
	struct FFeatureFlag FeatureFlag; // 0x00(0x0c)
	char UnknownData_C[0x4]; // 0x0c(0x04)
	struct TArray<struct FStringAssetReference> Loadouts; // 0x10(0x10)
	int32_t RankOffset; // 0x20(0x04)
	float Weight; // 0x24(0x04)
	int32_t MaxPerEncounter; // 0x28(0x04)
	char UnknownData_2C[0x4]; // 0x2c(0x04)
};
...
struct FAIEncounterAndWaveSettingsOverride {
	...
	struct TArray<struct UAISpawnerPrerequisiteBase*> Prerequisites; // 0x18(0x10)
};
...
struct FAIExclusionZone {
	...
	struct FTimerHandle RemoveTimer; // 0x28(0x04)
};
...
struct FAIPerCrewSpawnerCrewUnit {
	...
	struct TArray<struct UAISpawnerPrerequisiteBase*> Prerequisites; // 0x30(0x10)
};
...
// ScriptStruct AthenaAI.EventAIFormEncounteredByLocalPlayer
// Size: 0x18 (Inherited: 0x10)
struct FEventAIFormEncounteredByLocalPlayer : FNetworkEventStruct {
	struct UClass* FormType; // 0x10(0x08)
};
...
struct FAISpawnerTelemetryEvent {
	struct FString AISpawnerSourceAsset; // 0x00(0x10)
	struct FString AISpawnerType; // 0x10(0x10)
	struct FString AISpawnerRegion; // 0x20(0x10)
	struct TArray<struct FString> AISpawnerContexts; // 0x30(0x10)
	int32_t AISpawnerWaveSpawnNumber; // 0x40(0x04)
	float AISpawnerWaveDelayBefore; // 0x44(0x04)
	float AISpawnerWaveDelayAfter; // 0x48(0x04)
...
// ScriptStruct AthenaAI.FaunaSpeciesRequirement
// Size: 0x18 (Inherited: 0x00)
struct FFaunaSpeciesRequirement {
	struct UClass* Species; // 0x00(0x08)
	struct TArray<struct FFaunaBreedRequirement> Breeds; // 0x08(0x10)
};

// ScriptStruct AthenaAI.FaunaBreedRequirement
// Size: 0x10 (Inherited: 0x00)
struct FFaunaBreedRequirement {
	struct UClass* Breed; // 0x00(0x08)

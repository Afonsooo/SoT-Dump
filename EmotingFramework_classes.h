...
struct AEmoteDice : AActor {
	...
	void SetDiceMesh(char* DiceType); // Function EmotingFramework.EmoteDice.SetDiceMesh // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
	void SendTelemetryData(struct FTransform* OrientationUsed, int32_t* RollNumber, char* DiceType); // Function EmotingFramework.EmoteDice.SendTelemetryData // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3cfc5a0
	void RollDice(int32_t* RollNumber, char* DiceType); // Function EmotingFramework.EmoteDice.RollDice // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3cfc4d0
};

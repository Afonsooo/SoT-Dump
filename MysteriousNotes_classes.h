...
struct AMysteriousNotesService : AActor {
	...
	char UnknownData_408[0x58]; // 0x408(0x58)
};
...
struct UPlayerMysteriousNoteComponent : UActorComponent {
	...
	void TriggerNotesReceivedPopup(bool InCinematicSkipped); // Function MysteriousNotes.PlayerMysteriousNoteComponent.TriggerNotesReceivedPopup // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x4b37bc0
	void Server_NoteCompletionStepReceived(struct APlayerController* InPlayerController, struct FName InCompletionID); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_NoteCompletionStepReceived // Net|NetReliableNative|Event|Protected|NetServer|NetValidate // @ game+0x4b37ac0
	void Server_MarkNoteAsRead(struct APlayerController* InPlayerController, struct FGuid NoteId); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_MarkNoteAsRead // Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate // @ game+0x4b379c0
	void Server_MarkNoteAsDeleted(struct APlayerController* InPlayerController, struct FGuid NoteId); // Function MysteriousNotes.PlayerMysteriousNoteComponent.Server_MarkNoteAsDeleted // Net|NetReliableNative|Event|Protected|NetServer|HasDefaults|NetValidate // @ game+0x4b378c0
	void OnRep_NoteData(); // Function MysteriousNotes.PlayerMysteriousNoteComponent.OnRep_NoteData // Final|RequiredAPI|Native|Private // @ game+0x4b37780
	void OnRep_BeenPossessed(); // Function MysteriousNotes.PlayerMysteriousNoteComponent.OnRep_BeenPossessed // Final|RequiredAPI|Native|Private // @ game+0x4b37760
	void CustomServerUpdateDetailNotes(struct TArray<struct FNotesRemoteServiceNoteDetailModel> InNotes); // Function MysteriousNotes.PlayerMysteriousNoteComponent.CustomServerUpdateDetailNotes // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x4b37650
	void AddFakeNote(struct FString NoteType, struct FString NoteTitle, struct FString NoteBody, struct TArray<struct FString> CompletionStrings); // Function MysteriousNotes.PlayerMysteriousNoteComponent.AddFakeNote // RequiredAPI|Net|NetReliableNative|Event|Public|NetClient // @ game+0x4b37470
};

// Class MysteriousNotes.WieldableMysteriousNote
// Size: 0x990 (Inherited: 0x7f0)
struct AWieldableMysteriousNote : ASkeletalMeshWieldableItem {
	char UnknownData_7F0[0x8]; // 0x7f0(0x08)
	struct UMaybeCompressedCanvasRenderTarget2D* RenderTarget; // 0x7f8(0x08)
	int32_t CanvasWidth; // 0x800(0x04)
	int32_t CanvasHeight; // 0x804(0x04)
	float FontScale; // 0x808(0x04)
	char UnknownData_80C[0x5c]; // 0x80c(0x5c)
	struct UWieldableMysteriousNoteLayout* NoteLayout; // 0x868(0x08)
	struct UUsableWieldableComponent* UsableWieldableComponent; // 0x870(0x08)
	struct UInventoryItemComponent* InventoryItemComponent; // 0x878(0x08)
	char UnknownData_880[0x110]; // 0x880(0x110)

	void OnTextCanvasUpdate(struct UCanvas* Canvas, int32_t Width, int32_t Height); // Function MysteriousNotes.WieldableMysteriousNote.OnTextCanvasUpdate // Final|Native|Private // @ game+0x4b377c0
	void OnRep_NoteLayout(); // Function MysteriousNotes.WieldableMysteriousNote.OnRep_NoteLayout // Final|RequiredAPI|Native|Private // @ game+0x4b377a0
};

...
struct Absp_bottle_hanging_light_a_C : AStaticMeshActor {
	...
	void UserConstructionScript(); // Function bsp_bottle_hanging_light_a.bsp_bottle_hanging_light_a_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
};

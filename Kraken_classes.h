...
struct AKrakenTentacle : AActor {
	...
	void OnDamageToTentacle(struct FImpactDamageEvent* ImpactDamageEvent); // Function Kraken.KrakenTentacle.OnDamageToTentacle // Final|Native|Public|HasOutParms // @ game+0x4a45e20
};
...
struct AMurk : AActor {
	...
	void DeactivateMurkBP(); // Function Kraken.Murk.DeactivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x4a45c00
	void ActivateMurkBP(); // Function Kraken.Murk.ActivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x4a45b60
};
...
struct AKrakenShipWrappingTentacle : AKrakenTentacle {
	...
	void OnRep_CurrentServerAnimationState(); // Function Kraken.KrakenShipWrappingTentacle.OnRep_CurrentServerAnimationState // Final|Native|Private // @ game+0x4a45f20
};
...
struct AKraken : AActor {
	...
	void Multicast_OnTentacleTakenDamage(); // Function Kraken.Kraken.Multicast_OnTentacleTakenDamage // Final|Net|Native|Event|NetMulticast|Private // @ game+0x4a45d80
	void AddActorToKnownTargets(struct AActor* Target); // Function Kraken.Kraken.AddActorToKnownTargets // Final|Native|Public|BlueprintCallable // @ game+0x4a45b80
};
...
struct AKrakenHead : AActor {
	...
	void TestSetDamageEnabled(bool InEnabled); // Function Kraken.KrakenHead.TestSetDamageEnabled // Final|Native|Public|BlueprintCallable // @ game+0x4a46100
	void RequestState(struct UClass* NewState); // Function Kraken.KrakenHead.RequestState // Native|Public|HasOutParms|BlueprintCallable // @ game+0x4a46060
	void OnRep_IsDamageEnabled(); // Function Kraken.KrakenHead.OnRep_IsDamageEnabled // Final|Native|Protected // @ game+0x4a45f60
	void OnRep_HeadStateRequest(); // Function Kraken.KrakenHead.OnRep_HeadStateRequest // Final|Native|Protected // @ game+0x4a45f40
	void OnCoordinatedKrakenSpecialEvent(char InEventType); // Function Kraken.KrakenHead.OnCoordinatedKrakenSpecialEvent // Final|Native|Private // @ game+0x4a45da0
};
...
struct AKrakenService : AActor {
	...
	void Test_TrySpawningKraken(); // Function Kraken.KrakenService.Test_TrySpawningKraken // Final|Native|Public|BlueprintCallable // @ game+0x4a46260
	void Test_SetTargetShip(struct AShip* InShip); // Function Kraken.KrakenService.Test_SetTargetShip // Final|Native|Public|BlueprintCallable // @ game+0x4a461e0
	bool Test_IsCurrentStateInactive(); // Function Kraken.KrakenService.Test_IsCurrentStateInactive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4a461b0
	bool Test_IsCurrentStateActive(); // Function Kraken.KrakenService.Test_IsCurrentStateActive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4a46180
	void RequestKrakenWithLocation(struct FVector SpawnLocation, struct AActor* SpawnedForActor); // Function Kraken.KrakenService.RequestKrakenWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4a45f80
	bool IsServiceInitialized(); // Function Kraken.KrakenService.IsServiceInitialized // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4a45d50
	bool IsKrakenActive(); // Function Kraken.KrakenService.IsKrakenActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4a45d10
	bool DismissOrRemoveCrewFromKraken(struct FGuid InCrewId); // Function Kraken.KrakenService.DismissOrRemoveCrewFromKraken // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4a45c60
	bool DismissKraken(); // Function Kraken.KrakenService.DismissKraken // Native|Public|BlueprintCallable // @ game+0x4a45c20
};

...
struct ABP_FogBankManager_C : AFogBankManager {
	...
	void UserConstructionScript(); // Function BP_FogBankManager.BP_FogBankManager_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
};

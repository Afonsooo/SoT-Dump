...
struct AShortRangeMarker : AActor {
	...
	void Multicast_OnCleanUp(); // Function ShortRangeMarkerFramework.ShortRangeMarker.Multicast_OnCleanUp // Net|NetReliableNative|Event|NetMulticast|Protected // @ game+0x40ec5b0
};

...
struct UClueDestinationDescriptor : UObject {
	...
	void OnRep_DestinationInfo(); // Function LostShipmentsClueFramework.ClueDestinationDescriptor.OnRep_DestinationInfo // Native|Public // @ game+0x1a3da10
};
...
struct UClueLifetimeBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void GiveClueToParticipant(struct AActor** Participant, struct UClueDescriptor** Clue, struct UClass** ClueSite); // Function LostShipmentsClueFramework.ClueLifetimeBlueprintFunctionLibrary.GiveClueToParticipant // Final|Native|Static|Public|BlueprintCallable // @ game+0x1a3d920
};
...
struct UTaleQuestClueSiteService : UTaleQuestService {
	...
	struct TArray<struct FClueSite> GetClueSites(); // Function LostShipmentsClueFramework.TaleQuestClueSiteService.GetClueSites // Final|Native|Public|BlueprintCallable // @ game+0x1a3d890
};

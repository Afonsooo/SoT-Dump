...
struct FSeasonTextPopupAsset {
	...
	float ToastHoldDuration; // 0x98(0x04)
...
struct FSeasonsTextNotification {
	struct FStringAssetReference IconUrl; // 0x00(0x10)
	struct FText Message; // 0x10(0x38)
	struct FGenericPopupAudioDescriptor Audio; // 0x48(0x40)
};
...
struct FSeasonsTextNotificationNetworkEvent : FNetworkEventStruct {
	struct FSeasonsTextNotification SeasonsTextNotification; // 0x10(0x88)
};

// ScriptStruct SeasonProgressionUI.SeasonsChatNotificationNetworkEvent
// Size: 0x70 (Inherited: 0x10)
struct FSeasonsChatNotificationNetworkEvent : FNetworkEventStruct {
	struct FSeasonsChatNotificationEvent SeasonsChatNotificationEvent; // 0x10(0x60)
};

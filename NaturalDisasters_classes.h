...
struct AAshenLordAshCloud : AActor {
	...
	void UpdatePostSettingsBP(); // Function NaturalDisasters.AshenLordAshCloud.UpdatePostSettingsBP // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
	void SetDissipationDensityBP(float* CloudDensity); // Function NaturalDisasters.AshenLordAshCloud.SetDissipationDensityBP // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e25660
	void OnRep_StateChanged(); // Function NaturalDisasters.AshenLordAshCloud.OnRep_StateChanged // Final|Native|Private // @ game+0x4c58500
};
...
struct AAshenLordWorldEndCloud : AActor {
	...
	void OnRep_CloudStateChange(); // Function NaturalDisasters.AshenLordWorldEndCloud.OnRep_CloudStateChange // Final|Native|Public // @ game+0x4c58420
	void AnimateCloud(float* AdjustedLifetime); // Function NaturalDisasters.AshenLordWorldEndCloud.AnimateCloud // Event|Public|BlueprintEvent // @ game+0x1e25660
};
...
struct AGeyser : AActor {
	...
	void OnRep_GeyserState(); // Function NaturalDisasters.Geyser.OnRep_GeyserState // Final|Native|Private // @ game+0x4c584c0
	void Multicast_TriggerExplosion(); // Function NaturalDisasters.Geyser.Multicast_TriggerExplosion // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x4c57e70
};
...
struct ADisableGeyserMechanismAction : AActor {
	...
	void OnActionStateChanged(TScriptInterface<struct UMechanismActionInterface>* Action, char* PreviousState, char* NewState, struct AActor** InInstigator); // Function NaturalDisasters.DisableGeyserMechanismAction.OnActionStateChanged // Native|Public // @ game+0x4c57f30
	void OnActionReset(TScriptInterface<struct UMechanismResetInterface>* Mechanism); // Function NaturalDisasters.DisableGeyserMechanismAction.OnActionReset // Native|Public // @ game+0x4c57e90
};
...
struct AEarthquake : AActor {
	...
	void OnRep_EarthquakeState(char* OldEarthquakeState); // Function NaturalDisasters.Earthquake.OnRep_EarthquakeState // Final|Native|Private // @ game+0x4c58440
};
...
struct AMechanismGeyser : AGeyser {
	...
	void OnMechanismActionStateChanged(TScriptInterface<struct UMechanismActionInterface>* Action, char* PreviousState, char* NewState, struct AActor** InInstigator); // Function NaturalDisasters.MechanismGeyser.OnMechanismActionStateChanged // Final|Native|Public // @ game+0x4c581d0
	void OnMechanismActionReset(TScriptInterface<struct UMechanismResetInterface>* Action); // Function NaturalDisasters.MechanismGeyser.OnMechanismActionReset // Final|Native|Private // @ game+0x4c58130
};
...
struct UGeyserItemSpawnComponent : UItemSpawnComponent {
	char UnknownData_480[0x20]; // 0x480(0x20)

	void OnGeyserSpawned(struct FVector GeyserSpawnLocation); // Function NaturalDisasters.GeyserItemSpawnComponent.OnGeyserSpawned // Final|Native|Private|HasOutParms|HasDefaults // @ game+0x4c580a0
};
...
struct ALavaZone : AActor {
	...
	void OnRep_ActorsInZone(struct TArray<struct AActor*> PreviousActors); // Function NaturalDisasters.LavaZone.OnRep_ActorsInZone // Final|Native|Private|HasOutParms // @ game+0x4c58370
	void OnRep_Active(); // Function NaturalDisasters.LavaZone.OnRep_Active // Final|Native|Private // @ game+0x4c58350
};
...
struct ASuperheatedWater : AMurk {
	...
	void OnRep_PlayersInZone(); // Function NaturalDisasters.SuperheatedWater.OnRep_PlayersInZone // Final|Native|Private // @ game+0x4c584e0
};
...
struct AVolcano : AActor {
	...
	void OnRep_VolcanoState(struct FVolcanoStateData OldVolcanoState); // Function NaturalDisasters.Volcano.OnRep_VolcanoState // Final|Native|Private // @ game+0x4c58520
	void Multicast_FireProjectile(struct FVector AuthoritySpawnLocation, struct TArray<struct FVolcanoProjectileData> VolcanoProjectileDataArray); // Function NaturalDisasters.Volcano.Multicast_FireProjectile // Final|Net|NetReliableNative|Event|NetMulticast|Private|HasDefaults // @ game+0x4c57d90
};

...
struct UAudioPortalComponent : USceneComponent {
	...
	void SetParentShip(struct AActor* ParentShip); // Function AthenaAudio.AudioPortalComponent.SetParentShip // Native|Public|BlueprintCallable // @ game+0x3dd2f80
};
...
struct UAudioPortalInterface : UInterface {
	...
	void UnregisterPortal(struct UAudioPortalComponent** AudioPortal); // Function AthenaAudio.AudioPortalInterface.UnregisterPortal // Native|Public|BlueprintCallable // @ game+0x3dd3010
	void RegisterPortal(struct UAudioPortalComponent* AudioPortal, struct AActor* OwningActor); // Function AthenaAudio.AudioPortalInterface.RegisterPortal // Native|Public|BlueprintCallable // @ game+0x3dd2ea0
	struct TArray<struct UAudioPortalComponent*> GetAllRegisteredPortalsInSpecificSpace(struct UAudioSpaceDataAsset* AudioSpace, struct AActor* OwningActor); // Function AthenaAudio.AudioPortalInterface.GetAllRegisteredPortalsInSpecificSpace // Native|Public // @ game+0x3dd2ad0
	struct TArray<struct UAudioPortalComponent*> GetAllRegisteredPortals(); // Function AthenaAudio.AudioPortalInterface.GetAllRegisteredPortals // Native|Public|Const // @ game+0x3dd2a80
};
...
struct UAudioSpaceComponent : UStaticMeshComponent {
	struct UAudioSpaceDataAsset* AudioSpace; // 0x630(0x08)
	struct UAudioSpaceDataAsset* ActiveAudioSpace; // 0x638(0x08)
	struct UStoryDrivenAudioPortalDataAsset* CollectionAsset; // 0x640(0x08)
	char UnknownData_648[0x18]; // 0x648(0x18)

	void OnOverlapEnd(struct AActor** OtherActor, struct UPrimitiveComponent** OtherComp, int32_t* OtherBodyIndex); // Function AthenaAudio.AudioSpaceComponent.OnOverlapEnd // Final|Native|Private // @ game+0x3dd2da0
	void OnOverlapBegin(struct AActor** OtherActor, struct UPrimitiveComponent** OtherComp, int32_t* OtherBodyIndex, bool* FromSweep, struct FHitResult* SweepResult); // Function AthenaAudio.AudioSpaceComponent.OnOverlapBegin // Final|Native|Private|HasOutParms // @ game+0x3dd2be0
};
...
struct UAudioSpaceTrackerComponent : UActorComponent {
	...
	struct UAudioSpaceDataAsset* GetCurrentSpace(); // Function AthenaAudio.AudioSpaceTrackerComponent.GetCurrentSpace // Final|Native|Public|BlueprintCallable // @ game+0x3dd2bb0
};
...
struct AMultiEmitter : AActor {
	...
	void ResetNamingCount(); // Function AthenaAudio.MultiEmitter.ResetNamingCount // Final|Native|Public|BlueprintCallable // @ game+0x3dd2f60
	void CreateAndAddMergedEmitterComponentToRoot(struct FName* InName, struct FVector* InOffset, struct UWwiseEvent** InWwiseEvent, struct UWwiseObjectPoolWrapper** InPool); // Function AthenaAudio.MultiEmitter.CreateAndAddMergedEmitterComponentToRoot // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3dd2920
};

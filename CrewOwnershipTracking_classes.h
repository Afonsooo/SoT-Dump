...
struct UCrewOwnershipTrackingComponent : UActorComponent {
	...
	struct FGuid GetSpawningCrewIdByCopy(); // Function CrewOwnershipTracking.CrewOwnershipTrackingComponent.GetSpawningCrewIdByCopy // Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x3db4290
};

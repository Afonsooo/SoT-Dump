...
struct UOceanCrawlerAnimationInstance : UAnimInstance {
	...
	void ClearActiveAttack(); // Function OceanCrawlersAnimation.OceanCrawlerAnimationInstance.ClearActiveAttack // Final|Native|Public|BlueprintCallable // @ game+0x1aac410
	void BeginNewAttack(); // Function OceanCrawlersAnimation.OceanCrawlerAnimationInstance.BeginNewAttack // Final|Native|Public|BlueprintCallable // @ game+0x1aac3f0
};

...
struct UActorOfInterestBlueprintFunctionLibrary : UObject {
	...
	void GetActorsOfInterestFromIds(struct UObject* WorldContextObject, struct TArray<struct UClass*> ActorOfInterestIds, struct TArray<struct AActor*> Actors); // Function ActorOfInterestFramework.ActorOfInterestBlueprintFunctionLibrary.GetActorsOfInterestFromIds // Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x43aa280
	struct AActor* GetActorOfInterestFromId(struct UObject* WorldContextObject, struct UClass* ActorOfInterestId); // Function ActorOfInterestFramework.ActorOfInterestBlueprintFunctionLibrary.GetActorOfInterestFromId // Final|RequiredAPI|Native|Static|Public|BlueprintCallable // @ game+0x43aa1c0
};

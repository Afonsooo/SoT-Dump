...
struct FOnEndZiplineActionStateEvent {
	...
	struct UWwiseEvent* DetachFromZiplineAdditiveOneShot; // 0x10(0x08)
};
...
struct FOnStartZiplineActionStateEvent {
	...
	struct UWwiseEvent* AttachToZiplineAdditiveOneShot; // 0x08(0x08)
...
struct FZiplineActionStateConstructionInfo : FActorActionStateConstructionInfo {
	...
	char InitialSwingDirection; // 0x39(0x01)
	char UnknownData_3A[0x6]; // 0x3a(0x06)
	double ZiplineStartSmoothedTime; // 0x40(0x08)
};

...
// Class BarrelsOfPlenty.BarrelsOfPlentySpawnManagerProviderInterface
// Size: 0x28 (Inherited: 0x28)
struct UBarrelsOfPlentySpawnManagerProviderInterface : UInterface {
};

// Class BarrelsOfPlenty.BarrelsOfPlentySpawnProxy
// Size: 0x3f0 (Inherited: 0x3c8)
struct ABarrelsOfPlentySpawnProxy : AActor {
	struct AActor* Ship; // 0x3c8(0x08)

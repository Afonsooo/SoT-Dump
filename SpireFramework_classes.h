...
struct UHeightTriggerableEffectsComponent : UActorComponent {
	...
	void SetMovementDirection(char* InMovement); // Function SpireFramework.HeightTriggerableEffectsComponent.SetMovementDirection // Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable // @ game+0x5128880
};
...
struct ASpireService : AActor {
	...
	void OnRep_SpireLevels(struct TArray<struct FSpireInfo>* InPreviousSpireLevels); // Function SpireFramework.SpireService.OnRep_SpireLevels // Final|Native|Private|HasOutParms // @ game+0x5128750
};
...
struct UTaleSpireService : UTaleQuestService {
	...
	void RegisterResetMechanismInterface(struct AActor** InMechanismResetInterface); // Function SpireFramework.TaleSpireService.RegisterResetMechanismInterface // Final|Native|Public|BlueprintCallable // @ game+0x5128800
	bool IsSpireVisible(); // Function SpireFramework.TaleSpireService.IsSpireVisible // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5128720
};

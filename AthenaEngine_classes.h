...
struct UForceFeedbackCondition : UObject {
	...
	bool CanPlayForceFeedback(struct AActor** InOwner); // Function AthenaEngine.ForceFeedbackCondition.CanPlayForceFeedback // Native|Event|Public|BlueprintEvent|Const // @ game+0x396d3f0
};

// Class AthenaEngine.AdaptiveTriggerComponent
// Size: 0xd0 (Inherited: 0xc8)
struct UAdaptiveTriggerComponent : UActorComponent {
	char UnknownData_C8[0x8]; // 0xc8(0x08)
};

// Class AthenaEngine.AdaptiveTriggerInterface
// Size: 0x28 (Inherited: 0x28)
struct UAdaptiveTriggerInterface : UInterface {
};

// Class AthenaEngine.AdaptiveTriggerControllerInterface
// Size: 0x28 (Inherited: 0x28)
struct UAdaptiveTriggerControllerInterface : UInterface {
};
...
struct UBoxedRpcDispatcherComponent : UActorComponent {
	...
	void Server_SendRpc(struct FSerialisedRpc* Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.Server_SendRpc // Net|NetReliableNative|Event|Protected|NetServer|NetValidate // @ game+0x396da50
	void NetMulticastExcludeServer_SendRpc(struct FSerialisedRpc* Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.NetMulticastExcludeServer_SendRpc // Net|NetReliableNative|Event|NetMulticast|Protected // @ game+0x396d8b0
	void Client_SendRpc(struct FSerialisedRpc* Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.Client_SendRpc // Net|NetReliableNative|Event|Protected|NetClient // @ game+0x396d4d0
};
...
struct UDynamicColourPointLightComponent : UPointLightComponent {
	...
	void DeactivateLight(bool* Blend); // Function AthenaEngine.DynamicColourPointLightComponent.DeactivateLight // Final|Native|Public|BlueprintCallable // @ game+0x396d5e0
	void ActivateLight(bool* Blend); // Function AthenaEngine.DynamicColourPointLightComponent.ActivateLight // Final|Native|Public|BlueprintCallable // @ game+0x396d330
};
...
// Class AthenaEngine.HUDInterface
// Size: 0x28 (Inherited: 0x28)
...
struct UPersistentAssetCollectionDataAsset : UDataAsset {
	struct TArray<struct UClass*> Blueprints; // 0x28(0x10)
	struct TArray<struct UDataAsset*> DataAssets; // 0x38(0x10)
};
...
struct UPlayModeHelpers : UBlueprintFunctionLibrary {
	...
	void SetPlayModeVariantOverride(char* NewPlayModeVariantOverride); // Function AthenaEngine.PlayModeHelpers.SetPlayModeVariantOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x396dc00
	void SetPlayModeOverride(char* NewPlayModeOverride); // Function AthenaEngine.PlayModeHelpers.SetPlayModeOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x396db90
	bool HasPlayModeVariantBeenSet(struct UObject** WorldContext); // Function AthenaEngine.PlayModeHelpers.HasPlayModeVariantBeenSet // Final|Native|Static|Public|BlueprintCallable // @ game+0x396d770
	char GetPlayModeVariant(struct UObject** WorldContext); // Function AthenaEngine.PlayModeHelpers.GetPlayModeVariant // Final|Native|Static|Public|BlueprintCallable // @ game+0x396d6f0
	char GetPlayMode(struct UObject** WorldContext); // Function AthenaEngine.PlayModeHelpers.GetPlayMode // Final|Native|Static|Public|BlueprintCallable // @ game+0x396d670
	void ClearPlayModeVariantOverride(); // Function AthenaEngine.PlayModeHelpers.ClearPlayModeVariantOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x396d4b0
	void ClearPlayModeOverride(); // Function AthenaEngine.PlayModeHelpers.ClearPlayModeOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x396d490
};
...
struct URotateMeshToActorComponent : UActorComponent {
	...
	void SnapMeshToLookAtActor(); // Function AthenaEngine.RotateMeshToActorComponent.SnapMeshToLookAtActor // Final|Native|Public|BlueprintCallable // @ game+0x396dca0
	void Initialise(struct UMeshComponent** InMeshToRotate, struct AActor** InActorToRotateTo); // Function AthenaEngine.RotateMeshToActorComponent.Initialise // Final|Native|Public|BlueprintCallable // @ game+0x396d7f0
};

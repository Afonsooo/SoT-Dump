...
struct UGenericStatusVFXInterface : UInterface {
	...
	void IncrementVFXSource(); // Function GenericStatusVFX.GenericStatusVFXInterface.IncrementVFXSource // Native|Public|BlueprintCallable // @ game+0x4e586d0
	void DecrementVFXSource(); // Function GenericStatusVFX.GenericStatusVFXInterface.DecrementVFXSource // Native|Public|BlueprintCallable // @ game+0x4e586b0
};
...
struct UGenericStatusVFXComponent : UActorComponent {
	...
	void OnRep_ContainsVFXSource(); // Function GenericStatusVFX.GenericStatusVFXComponent.OnRep_ContainsVFXSource // Final|Native|Private // @ game+0x4e586f0
};

...
struct UTurnBasedMatchInterface : UInterface {
	...
	void OnMatchReceivedTurn(struct FString Match, bool bDidBecomeActive); // Function OnlineSubsystem.TurnBasedMatchInterface.OnMatchReceivedTurn // Event|Public|BlueprintEvent // @ game+0x1e25660
	void OnMatchEnded(struct FString Match); // Function OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded // Event|Public|BlueprintEvent // @ game+0x1e25660
};

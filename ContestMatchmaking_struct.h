...
struct FServerQueueWaitTimesRequestModel {
	...
	struct TArray<struct FString> PlayModeTags; // 0x48(0x10)
...
struct FContestMatchmakingServerRequestModel {
	...
	uint32_t FeatureHash; // 0x60(0x04)
	char UnknownData_64[0x4]; // 0x64(0x04)
	struct TArray<struct FString> PlayModeTags; // 0x68(0x10)
	struct TArray<struct FString> PlayModeStates; // 0x78(0x10)
	struct TArray<struct FServerCrewModel> Crews; // 0x88(0x10)
	char MatchmakingRequestReason; // 0x98(0x01)
	char UnknownData_99[0x3]; // 0x99(0x03)
	struct FGuid RequestCorrelationId; // 0x9c(0x10)
	struct FGuid SaferSeasServerIdOverride; // 0xac(0x10)
...
struct FServerCrewModel {
	...
	struct FGuid GuildId; // 0xb8(0x10)
	struct TArray<struct FUniqueNetIdRepl> CrewMemberUserIds; // 0xc8(0x10)
};
...
struct FServerCrewRequestModel {
	...
	struct FGuid SaferSeasServerId; // 0x30(0x10)
	struct FString ServerLocation; // 0x40(0x10)
	struct FString ServerForcedPlatform; // 0x50(0x10)
	struct FString StampId; // 0x60(0x10)
	uint32_t FeatureHash; // 0x70(0x04)
	char UnknownData_74[0x4]; // 0x74(0x04)
	struct TArray<struct FString> PlayModeTags; // 0x78(0x10)
	struct FString PlayModeState; // 0x88(0x10)
	int32_t CrewCount; // 0x98(0x04)
	int32_t CrewCountBucket; // 0x9c(0x04)
	int32_t CrewMin; // 0xa0(0x04)
	int32_t CrewMax; // 0xa4(0x04)
	struct TArray<int32_t> CrewSessionTypes; // 0xa8(0x10)
	struct TArray<struct FExistingServerCrewModel> Crews; // 0xb8(0x10)
	struct FTimespan Uptime; // 0xc8(0x08)
	struct FServerContendedModel Contended; // 0xd0(0x30)
	struct FGameEventAvailabilityModel GameEvents; // 0x100(0x20)
};
...
struct FGameMainEventTypeModel {
	...
	struct TArray<struct FGuid> ExcludedCrewIds; // 0x20(0x10)
	char Status; // 0x30(0x01)
	char ShipSizeLimit; // 0x31(0x01)
...
struct FExistingServerCrewModel {
	...
	struct FGuid GuildId; // 0x38(0x10)
	struct TArray<struct FUniqueNetIdRepl> CrewMemberUserIds; // 0x48(0x10)
};

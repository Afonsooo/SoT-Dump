...
// Size: 0x718 (Inherited: 0x610)
struct AFireworkProjectile : ALaunchableProjectile {
	char UnknownData_610[0x10]; // 0x610(0x10)
	struct USphereComponent* CollisionComponent; // 0x620(0x08)
	struct UStaticMeshComponent* MeshComponent; // 0x628(0x08)
	struct UExplosionComponent* ExplosionComponent; // 0x630(0x08)
	struct UFireworkStatsComponent* FireworkStatsComponent; // 0x638(0x08)
	struct USceneComponent* MeshDirectionComponent; // 0x640(0x08)
	struct UProjectileAnimationComponent* AnimationComponent; // 0x648(0x08)
	struct FGeneratedFireworkData GeneratedFireworkData; // 0x650(0x58)
	char UnknownData_6A8[0x70]; // 0x6a8(0x70)
};

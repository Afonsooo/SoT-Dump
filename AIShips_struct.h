...
struct FWeightedAIShipCrewAmmoType {
	...
	struct FFeatureFlag FeatureFlag; // 0x20(0x0c)
...
// ScriptStruct AIShips.AIShipCrewSizeSpecificSpawnerEntry
// Size: 0x18 (Inherited: 0x00)
struct FAIShipCrewSizeSpecificSpawnerEntry {
	int32_t CrewSize; // 0x00(0x04)
	char UnknownData_4[0x4]; // 0x04(0x04)
	struct TArray<struct FAIShipEncounterParamsSpawnerData> SpawnerTemplates; // 0x08(0x10)
};
...
struct FAIShipContextDescGenerationShipSpecificParams {
	...
	struct UAIShipEncounterSpawnerTemplateDataAsset* SpawnerTemplateDataAsset; // 0x10(0x08)
	struct TArray<struct FAIShipGenerationParams> ShipGenerationParams; // 0x18(0x10)
};
...
struct FAIShipEncounterParams {
	...
	struct FString MinEngagedDistanceFromPlayersRemoteConfigKey; // 0x08(0x10)
	struct TArray<struct FShipTypeAIShipEncounterParams> ShipTypeParams; // 0x18(0x10)
};
...
struct FToggleableAIShipsServiceDataAssetFileLocation {
	struct FName ToggleName; // 0x00(0x08)
	struct FStringAssetReference Location; // 0x08(0x10)
};

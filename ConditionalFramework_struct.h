...
struct FIsSpecifiedActorCondition : FConditionBase {
	struct FConditionContextPayloadSelectorInstance SpecifyingActorPayloadSelector; // 0x08(0x20)
	struct FConditionContextPayloadSelectorInstance TargetActorPayloadSelector; // 0x28(0x20)
};
...
struct FConditionContextPayloadComponentOwnerSelector : FConditionContextPayloadSelectorBase {
};

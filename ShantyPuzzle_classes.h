...
struct UShantyPuzzleCompletionComponent : UActorComponent {
	...
	void PlayReactions_Net(char State); // Function ShantyPuzzle.ShantyPuzzleCompletionComponent.PlayReactions_Net // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x5112fa0
};
...
struct UShantyPuzzleComponent : USceneComponent {
	...
	void OnEndOverlap(struct AActor* InActor, struct UPrimitiveComponent* InComponent, int32_t InOtherBodyIndex); // Function ShantyPuzzle.ShantyPuzzleComponent.OnEndOverlap // Final|Native|Public // @ game+0x5112ea0
	void OnBeginOverlap(struct AActor* InActor, struct UPrimitiveComponent* InComponent, int32_t InOtherBodyIndex, bool bFromSweep, struct FHitResult SweepResult); // Function ShantyPuzzle.ShantyPuzzleComponent.OnBeginOverlap // Final|Native|Public|HasOutParms // @ game+0x5112ce0
};

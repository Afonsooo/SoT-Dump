...
struct UGlitterBeardFinaleCoordinatorComponent : UActorComponent {
	...
	void OnRep_ReplicationState(struct FFinaleReplicationState* OldState); // Function GlitterBeard.GlitterBeardFinaleCoordinatorComponent.OnRep_ReplicationState // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x519ac20
};
...
struct AGlitterBeardTree : AActor {
	...
	void StopVocals(); // Function GlitterBeard.GlitterBeardTree.StopVocals // Final|Native|Public|BlueprintCallable // @ game+0x519ad60
	bool StopReaction(); // Function GlitterBeard.GlitterBeardTree.StopReaction // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x519ad20
	void StartVocals(); // Function GlitterBeard.GlitterBeardTree.StartVocals // Final|Native|Public|BlueprintCallable // @ game+0x519ad00
	bool StartReaction(); // Function GlitterBeard.GlitterBeardTree.StartReaction // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x519acc0
	void Reset_Impl(); // Function GlitterBeard.GlitterBeardTree.Reset_Impl // Event|Protected|BlueprintEvent // @ game+0x1e25660
};
...
struct UGlitterBeardTreeVisualFeedbackComponent : UActorComponent {
	...
	void OnRep_NextStateEvent(struct TArray<char>* OldStates); // Function GlitterBeard.GlitterBeardTreeVisualFeedbackComponent.OnRep_NextStateEvent // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x519ab70
};

...
// ScriptStruct Tales.PredicatedBranchedTask
// Size: 0x48 (Inherited: 0x00)
struct FPredicatedBranchedTask {
	TScriptInterface<struct UTaleQuestStepInterface> Task; // 0x00(0x10)
...
// ScriptStruct Tales.TaleQuestPredicateBranchedTaskDesc
// Size: 0x10 (Inherited: 0x00)
struct FTaleQuestPredicateBranchedTaskDesc {
	int32_t BranchIndex; // 0x00(0x04)
	char UnknownData_4[0x4]; // 0x04(0x04)
	struct UTaleQuestStepDesc* BranchedTask; // 0x08(0x08)
};

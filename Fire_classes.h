...
struct UFlammableComponent : UActorComponent {
	...
	void OnRep_OnFire(); // Function Fire.FlammableComponent.OnRep_OnFire // Final|Native|Protected // @ game+0x44575c0
	void Multicast_NotifyExtinguished_RPC(struct FVector* InExtinguishLocationWS); // Function Fire.FlammableComponent.Multicast_NotifyExtinguished_RPC // Net|Native|Event|NetMulticast|Protected|HasDefaults // @ game+0x4457540
	bool IsOnFire(); // Function Fire.FlammableComponent.IsOnFire // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4457500
	void IncrementFireSource(); // Function Fire.FlammableComponent.IncrementFireSource // Native|Public|BlueprintCallable // @ game+0x44574d0
	void DecrementFireSource(); // Function Fire.FlammableComponent.DecrementFireSource // Native|Public|BlueprintCallable // @ game+0x4457480
};
...
struct UFlammableInterface : UInterface {
	...
	void IncrementFireSource(); // Function Fire.FlammableInterface.IncrementFireSource // Native|Public|BlueprintCallable // @ game+0x44574b0
	void DecrementFireSource(); // Function Fire.FlammableInterface.DecrementFireSource // Native|Public|BlueprintCallable // @ game+0x4457460
};
...
struct UFirePropagationInterface : UInterface {
	...
	void SetAllCellsState(char* State); // Function Fire.FirePropagationInterface.SetAllCellsState // BlueprintAuthorityOnly|Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x4848bf0
};
...
// Class Fire.FirePropagatorDataAsset
// Size: 0x30 (Inherited: 0x28)
struct UFirePropagatorDataAsset : UDataAsset {
	struct UFirePropagator* FirePropagator; // 0x28(0x08)
};
...
struct UShipFirePropagationComponent : UActorComponent {
	...
	void OnRep_CellData(); // Function Fire.ShipFirePropagationComponent.OnRep_CellData // Final|Native|Private // @ game+0x4848bd0
	void OnRep_CellCharringData(); // Function Fire.ShipFirePropagationComponent.OnRep_CellCharringData // Final|Native|Private // @ game+0x4848bb0
};

...
struct USirenAnimationInstance : UAnimInstance {
	...
	void ClearActiveAttack(); // Function SirensAnimation.SirenAnimationInstance.ClearActiveAttack // Final|Native|Public|BlueprintCallable // @ game+0x1c170e0
	void BeginNewAttack(); // Function SirensAnimation.SirenAnimationInstance.BeginNewAttack // Final|Native|Public|BlueprintCallable // @ game+0x1c170c0
};

...
struct AAsymmetricObjectServerManager : AActor {
	...
	void OnRep_AsymmetricObjectAsset(); // Function AsymmetricClientServerObjectsFramework.AsymmetricObjectServerManager.OnRep_AsymmetricObjectAsset // Final|RequiredAPI|Native|Private // @ game+0x708080
};

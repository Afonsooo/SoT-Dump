...
struct UAbandonedNoteWeightedTextSourceComponent : UActorComponent {
	...
	void OnRep_TitleText(); // Function Mysteries.AbandonedNoteWeightedTextSourceComponent.OnRep_TitleText // Final|Native|Private // @ game+0x4f8cde0
	void OnRep_ClueText(); // Function Mysteries.AbandonedNoteWeightedTextSourceComponent.OnRep_ClueText // Final|Native|Private // @ game+0x4f8cd10
};
...
struct ASirenPuzzleContext : AActor {
	...
	void Unlock(struct FGuid LockId, struct FGuid CrewId); // Function Mysteries.SirenPuzzleContext.Unlock // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4f8ce20
	void ResetUnlock(); // Function Mysteries.SirenPuzzleContext.ResetUnlock // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x4f8ce00
	void OnRep_LockStates(struct TArray<char> OldStates); // Function Mysteries.SirenPuzzleContext.OnRep_LockStates // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x4f8cd30
	void DeactivateLock(struct FGuid LockId); // Function Mysteries.SirenPuzzleContext.DeactivateLock // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4f8cc70
	void ActivateLock(struct FGuid LockId); // Function Mysteries.SirenPuzzleContext.ActivateLock // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4f8cbd0
};

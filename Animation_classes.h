...
struct UAnimationDataFunctionLib : UBlueprintFunctionLibrary {
	...
	bool UnwrapAnimDataEntryStruct(struct FAnimDataEntryStructWrapper Wrapper, struct UScriptStruct* DestinationStruct, struct FGenericStruct Value); // Function Animation.AnimationDataFunctionLib.UnwrapAnimDataEntryStruct // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6e200
	struct UAnimationData* MakeAnimationData(struct UClass* Class); // Function Animation.AnimationDataFunctionLib.MakeAnimationData // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x3a6d090
	struct FAnimDataEntryStructWrapper GetAnimDataEntryStructAsStructWrapper(struct UAnimationData* AnimationDataObject, struct UScriptStruct* TheClass); // Function Animation.AnimationDataFunctionLib.GetAnimDataEntryStructAsStructWrapper // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x3a6c690
	void CheckAnimDataClassTypeForDuplicateAnimDataEntryStructs(struct UClass* InClass); // Function Animation.AnimationDataFunctionLib.CheckAnimDataClassTypeForDuplicateAnimDataEntryStructs // Final|Native|Static|Public // @ game+0x3a6c2d0
};
...
struct UAnimationDataStoreAsset : UDataAsset {
	...
	struct UAnimationData* LookupAnimationData(struct UClass* AnimDataId); // Function Animation.AnimationDataStoreAsset.LookupAnimationData // Final|Native|Public|BlueprintCallable // @ game+0x3a6d000
	struct UClass* GetAnimationDataClass(struct FAnimationDataStoreAssetEntry Entry); // Function Animation.AnimationDataStoreAsset.GetAnimationDataClass // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6c810
};
...
struct UAnimationDataStoreInterface : UInterface {
	...
	struct UAnimationData* GetAnimationDataForId(struct UClass* AnimDataId); // Function Animation.AnimationDataStoreInterface.GetAnimationDataForId // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3a6c8b0
};
...
struct UCosmeticItemAnimationInstance : UAnimInstance {
	...
	void UnregisterEvents(); // Function Animation.CosmeticItemAnimationInstance.UnregisterEvents // Final|Native|Private // @ game+0x3a6e1e0
};
...
struct UCustomAnimationMontageComponent : UActorComponent {
	...
	void OnRep_ReplicatedData(struct FCustomAnimationMontageComponentReplicatedData* PriorData); // Function Animation.CustomAnimationMontageComponent.OnRep_ReplicatedData // Final|Native|Private|HasOutParms // @ game+0x3a6d290
};
...
struct ULimbIKFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void SetTranslationStrength(struct FLimbIK* LimbIK, float* InRotationStrength); // Function Animation.LimbIKFunctionLibrary.SetTranslationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6dd20
	void SetTransform(struct FLimbIK* LimbIK, struct FTransform* InTransform); // Function Animation.LimbIKFunctionLibrary.SetTransform // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3a6dbd0
	void SetRotationStrength(struct FLimbIK* LimbIK, float* InRotationStrength); // Function Animation.LimbIKFunctionLibrary.SetRotationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6dad0
	void SetParentBone(struct FLimbIK* LimbIK, struct FName* Bone); // Function Animation.LimbIKFunctionLibrary.SetParentBone // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d9c0
	void SetIKSpace(struct FLimbIK* LimbIK, char* IKSpace); // Function Animation.LimbIKFunctionLibrary.SetIKSpace // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d8c0
	void SetEnabled(struct FLimbIK* LimbIK, bool* Enabled, char* IKSpace, struct FName* ParentBone); // Function Animation.LimbIKFunctionLibrary.SetEnabled // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d730
	void SetBlendOutSpeed(struct FLimbIK* LimbIK, float* BlendOutSpeed); // Function Animation.LimbIKFunctionLibrary.SetBlendOutSpeed // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d630
	void SetBlendInSpeed(struct FLimbIK* LimbIK, float* BlendInSpeed); // Function Animation.LimbIKFunctionLibrary.SetBlendInSpeed // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d530
	void SetAnimationOverride(struct FLimbIK* LimbIK, bool* AnimationOverride); // Function Animation.LimbIKFunctionLibrary.SetAnimationOverride // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d430
	void SetAlphaTarget(struct FLimbIK* LimbIK, float* AlphaTarget); // Function Animation.LimbIKFunctionLibrary.SetAlphaTarget // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6d330
	bool IsEnabled(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.IsEnabled // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6cf40
	float GetTranslationStrength(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetTranslationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6ce00
	struct FTransform GetTransform(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetTransform // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x3a6cd20
	float GetRotationStrength(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetRotationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6cc60
	struct FName GetParentBone(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetParentBone // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6cb90
	char GetIKSpace(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetIKSpace // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6cad0
	float GetCurrentAlpha(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetCurrentAlpha // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6ca10
	bool GetAnimationOverride(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetAnimationOverride // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6c950
	float GetAlphaTarget(struct FLimbIK* LimbIK); // Function Animation.LimbIKFunctionLibrary.GetAlphaTarget // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6c5d0
	float ConvertBoolToAlpha(bool* InBool); // Function Animation.LimbIKFunctionLibrary.ConvertBoolToAlpha // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x3a6c340
};
...
struct ULocomotionFunctionLib : UBlueprintFunctionLibrary {
	...
	float UpdateControllerSpineRotation(struct FRotator* CharacterRotation, float* AngleSpeedMax, float* AngleSpeedMin); // Function Animation.LocomotionFunctionLib.UpdateControllerSpineRotation // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x3a6e730
	struct FActorVelocityData UpdateCharacterSpeed(struct FVector* Velocity, float* CurrentMaxWalkSpeed, float* WantedMovementSpeed, float* BaseMaxWalkSpeed, float* SpeedBlendValue, bool* IsSwimming, float* DeadZone); // Function Animation.LocomotionFunctionLib.UpdateCharacterSpeed // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x3a6e500
	float UpdateCalculateRateAndCurrentYaw(struct FRotator* CharacterRotation, float* LargeRate, float* CurrentCharacterYaw, float* DeltaSeconds); // Function Animation.LocomotionFunctionLib.UpdateCalculateRateAndCurrentYaw // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x3a6e3a0
};
...
struct UNetworkSyncedAnimationComponent : UActorComponent {
	...
	void OnRep_PlayingAnimationIndex(); // Function Animation.NetworkSyncedAnimationComponent.OnRep_PlayingAnimationIndex // Final|Native|Protected // @ game+0x3a6d270
	void OnRep_AnimationProgression(); // Function Animation.NetworkSyncedAnimationComponent.OnRep_AnimationProgression // Final|Native|Protected // @ game+0x3a6d250
};
...
struct UTurningFunctionLib : UBlueprintFunctionLibrary {
	...
	bool TurningUpdate(float* DeltaSeconds, bool* CharacterMoving, bool* DeadZone, float* TurnRate, float* DelayedCounter, float* CounterMax, bool* TurningLeft); // Function Animation.TurningFunctionLib.TurningUpdate // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3a6dfb0
};
...
struct UWaitForAnimationStateEntryProxy : UObject {
	...
	void OnEnteredState(struct FName* path); // Function Animation.WaitForAnimationStateEntryProxy.OnEnteredState // Final|Native|Public // @ game+0x3a6d150
	void OnAnimationUpdated(); // Function Animation.WaitForAnimationStateEntryProxy.OnAnimationUpdated // Final|Native|Public // @ game+0x3a6d110
	struct UWaitForAnimationStateEntryProxy* CreateProxy(struct UAnimInstance** AnimInstance, struct FName* TargetPath); // Function Animation.WaitForAnimationStateEntryProxy.CreateProxy // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6c400
};
...
struct UWaitForAnimationStateExitProxy : UObject {
	...
	void OnExitState(struct FName* path); // Function Animation.WaitForAnimationStateExitProxy.OnExitState // Final|Native|Public // @ game+0x3a6d1d0
	void OnAnimationUpdated(); // Function Animation.WaitForAnimationStateExitProxy.OnAnimationUpdated // Final|Native|Public // @ game+0x3a6d130
	struct UWaitForAnimationStateExitProxy* CreateProxy(struct UAnimInstance** AnimInstance, struct FName* TargetPath); // Function Animation.WaitForAnimationStateExitProxy.CreateProxy // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3a6c4d0
};
...
struct UWeightedAnimSequenceLoadOnDemand : UObject {
	...
	void Initialise(struct UWeightedAnimationLoadOnDemandDataAsset** InAnimationData); // Function Animation.WeightedAnimSequenceLoadOnDemand.Initialise // Final|Native|Public|BlueprintCallable // @ game+0x3a6cec0
	struct UWeightedAnimSequenceLoadOnDemand* CreateNewWeightedAnimSequenceLoadOnDemand(); // Function Animation.WeightedAnimSequenceLoadOnDemand.CreateNewWeightedAnimSequenceLoadOnDemand // Final|Native|Static|Public|BlueprintCallable // @ game+0x3a6c3d0
};
...
struct UDockableInterface : UInterface {
	...
	void HandleDestroy(); // Function Animation.DockableInterface.HandleDestroy // Native|Public // @ game+0x3f31520
	struct FDockableInfo GetDockableInfo(); // Function Animation.DockableInterface.GetDockableInfo // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3f31400
};

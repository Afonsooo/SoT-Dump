...
struct UDescribableComponent : UInteractableComponent {
	...
	void SetTooltipActive(bool IsActive); // Function Describables.DescribableComponent.SetTooltipActive // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x19fb060
	void OnRep_TooltipActive(); // Function Describables.DescribableComponent.OnRep_TooltipActive // Final|RequiredAPI|Native|Private // @ game+0x19fb040
};

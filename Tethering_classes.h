...
struct UCordRenderComponent : UStaticMeshComponent {
	...
	struct TArray<struct UMaterialInstanceDynamic*> CordMaterials; // 0x638(0x10)
	float ThicknessCm; // 0x648(0x04)
	char UnknownData_64C[0x24]; // 0x64c(0x24)
};
...
struct UDynamicCordRenderComponent : UCordRenderComponent {
	float BoundsPadding; // 0x668(0x04)
	struct USceneComponent* EndPointA; // 0x670(0x08)
	struct USceneComponent* EndPointB; // 0x678(0x08)
	char UnknownData_684[0x4c]; // 0x684(0x4c)

	void SetCordEndPointB(struct USceneComponent* EndPointB); // Function Tethering.DynamicCordRenderComponent.SetCordEndPointB // Final|Native|Public|BlueprintCallable // @ game+0x3e7bb10
	void SetCordEndPointA(struct USceneComponent* EndPointA); // Function Tethering.DynamicCordRenderComponent.SetCordEndPointA // Final|Native|Public|BlueprintCallable // @ game+0x3e7ba90
};

// Class Tethering.HarpoonRenderComponent
// Size: 0x690 (Inherited: 0x670)
struct UHarpoonRenderComponent : UCordRenderComponent {
	struct TArray<struct UMaterialInstanceDynamic*> HarpoonMaterials; // 0x668(0x10)
	float LaunchAnimationDurationSecs; // 0x678(0x04)
	float HitAnimationDurationSecs; // 0x67c(0x04)
	float QuickRetractAnimationSpeed; // 0x680(0x04)

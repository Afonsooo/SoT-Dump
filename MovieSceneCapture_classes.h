...
struct UMovieSceneCaptureEnvironment : UObject {
	...
	int32_t GetCaptureFrameNumber(); // Function MovieSceneCapture.MovieSceneCaptureEnvironment.GetCaptureFrameNumber // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x2a93460
	float GetCaptureElapsedTime(); // Function MovieSceneCapture.MovieSceneCaptureEnvironment.GetCaptureElapsedTime // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x2a93430
};

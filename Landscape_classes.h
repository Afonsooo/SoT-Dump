...
// Size: 0x730 (Inherited: 0x5d0)
struct ULandscapeComponent : UPrimitiveComponent {
	int32_t SectionBaseX; // 0x5c8(0x04)
	int32_t SectionBaseY; // 0x5cc(0x04)
	int32_t ComponentSizeQuads; // 0x5d0(0x04)
	int32_t SubsectionSizeQuads; // 0x5d4(0x04)
	int32_t NumSubsections; // 0x5d8(0x04)
	struct UMaterialInterface* OverrideMaterial; // 0x5e0(0x08)
	struct UMaterialInterface* OverrideHoleMaterial; // 0x5e8(0x08)
	struct UMaterialInstanceConstant* MaterialInstance; // 0x5f0(0x08)
	struct TArray<struct FWeightmapLayerAllocationInfo> WeightmapLayerAllocations; // 0x5f8(0x10)
	struct TArray<struct UTexture2D*> WeightmapTextures; // 0x608(0x10)
	struct UTexture2D* XYOffsetmapTexture; // 0x618(0x08)
	struct FVector4 WeightmapScaleBias; // 0x620(0x10)
	float WeightmapSubsectionOffset; // 0x630(0x04)
	char UnknownData_638[0x8]; // 0x638(0x08)
	struct FVector4 HeightmapScaleBias; // 0x640(0x10)
	struct UTexture2D* HeightmapTexture; // 0x650(0x08)
	struct FBox CachedLocalBox; // 0x658(0x1c)
	struct ULandscapeHeightfieldCollisionComponent* CollisionComponent; // 0x674(0x1c)
	struct TArray<struct FGuid> IrrelevantLights; // 0x690(0x10)
	char UnknownData_6A0[0x10]; // 0x6a0(0x10)
	int32_t CollisionMipLevel; // 0x6b0(0x04)
	float StaticLightingResolution; // 0x6b4(0x04)
	int32_t ForcedLOD; // 0x6b8(0x04)
	int32_t LODBias; // 0x6bc(0x04)
	struct FGuid StateId; // 0x6c0(0x10)
	struct FGuid BakedTextureMaterialGuid; // 0x6d0(0x10)
	struct UTexture2D* GIBakedBaseColorTexture; // 0x6e0(0x08)
	char MobileBlendableLayerMask; // 0x6e8(0x01)
	char UnknownData_6E9[0x7]; // 0x6e9(0x07)
	struct UMaterialInterface* MobileMaterialInterface; // 0x6f0(0x08)
	struct UTexture2D* MobileWeightNormalmapTexture; // 0x6f8(0x08)
	char UnknownData_700[0x30]; // 0x700(0x30)
};
...
// Size: 0x6a0 (Inherited: 0x5d0)
struct ULandscapeHeightfieldCollisionComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeLayerInfoObject*> ComponentLayerInfos; // 0x5c8(0x10)
	int32_t SectionBaseX; // 0x5d8(0x04)
	int32_t SectionBaseY; // 0x5dc(0x04)
	int32_t CollisionSizeQuads; // 0x5e0(0x04)
	float CollisionScale; // 0x5e4(0x04)
	struct TArray<char> CollisionQuadFlags; // 0x5e8(0x10)
	struct FGuid HeightfieldGuid; // 0x5f8(0x10)
	struct FBox CachedLocalBox; // 0x608(0x1c)
	struct ULandscapeComponent* RenderComponent; // 0x624(0x1c)
	char UnknownData_648[0x8]; // 0x648(0x08)
	struct TArray<struct UPhysicalMaterial*> CookedPhysicalMaterials; // 0x650(0x10)
...
struct ULandscapeMeshCollisionComponent : ULandscapeHeightfieldCollisionComponent {
	struct FGuid MeshGuid; // 0x6a0(0x10)
...
struct ALandscapeProxy : AActor {
	...
	void EditorApplySpline(struct USplineComponent** InSplineComponent, float* StartWidth, float* EndWidth, float* StartSideFalloff, float* EndSideFalloff, float* StartRoll, float* EndRoll, int32_t* NumSubdivisions, bool* bRaiseHeights, bool* bLowerHeights, struct ULandscapeLayerInfoObject** PaintLayer); // Function Landscape.LandscapeProxy.EditorApplySpline // Final|Native|Public|BlueprintCallable // @ game+0x26c1650
	void ChangeLODDistanceFactor(float* InLODDistanceFactor); // Function Landscape.LandscapeProxy.ChangeLODDistanceFactor // Native|Public|BlueprintCallable // @ game+0x26c15d0
};

// Class Landscape.LandscapeMeshProxyComponent
// Size: 0x660 (Inherited: 0x630)
struct ULandscapeMeshProxyComponent : UStaticMeshComponent {
	struct FGuid LandscapeGuid; // 0x630(0x10)
	struct TArray<struct FIntPoint> ProxyComponentBases; // 0x640(0x10)
	int8_t ProxyLOD; // 0x650(0x01)
	char UnknownData_651[0xf]; // 0x651(0x0f)
};
...
struct ULandscapeSplinesComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeSplineControlPoint*> ControlPoints; // 0x5c8(0x10)
	struct TArray<struct ULandscapeSplineSegment*> Segments; // 0x5d8(0x10)
	struct TArray<struct UMeshComponent*> CookedForeignMeshComponents; // 0x5e8(0x10)
};

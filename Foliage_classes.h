...
// Size: 0x7d0 (Inherited: 0x7b0)
struct UFoliageInstancedStaticMeshComponent : UHierarchicalInstancedStaticMeshComponent {
	struct FMulticastDelegate OnInstanceTakePointDamage; // 0x7a8(0x10)
	struct FMulticastDelegate OnInstanceTakeRadialDamage; // 0x7b8(0x10)
};
...
struct UFoliageStatistics : UBlueprintFunctionLibrary {
	...
	int32_t FoliageOverlappingSphereCount(struct UObject** WorldContextObject, struct UStaticMesh** StaticMesh, struct FVector* CenterPosition, float* Radius); // Function Foliage.FoliageStatistics.FoliageOverlappingSphereCount // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x267d420
	int32_t FoliageOverlappingBoxCount(struct UObject** WorldContextObject, struct UStaticMesh** StaticMesh, struct FBox* Box); // Function Foliage.FoliageStatistics.FoliageOverlappingBoxCount // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x267d300
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	void CapsuleTouched(struct AActor** Other, struct UPrimitiveComponent** OtherComp, int32_t* OtherBodyIndex, bool* bFromSweep, struct FHitResult* OverlapInfo); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // Final|Native|Protected|HasOutParms // @ game+0x267d140
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	void Simulate(int32_t* NumSteps); // Function Foliage.ProceduralFoliageSpawner.Simulate // Final|Native|Public|BlueprintCallable // @ game+0x267d560
};

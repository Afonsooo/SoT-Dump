...
struct ACommodityDemandService : AActor {
	...
	void OnRep_ActiveCommodityDemands(); // Function CommodityDemandFramework.CommodityDemandService.OnRep_ActiveCommodityDemands // Final|RequiredAPI|Native|Private // @ game+0x4b0ee90
};
...
struct UCommodityRedemptionComponent : UActorComponent {
	...
	char UnknownData_108[0x80]; // 0x108(0x80)
	struct TArray<struct AActor*> PendingRedemptions; // 0x188(0x10)
};

...
struct UShipDamagerComponent : UActorComponent {
	...
	void SetShape(struct UPrimitiveComponent** InShape); // Function Damagers.ShipDamagerComponent.SetShape // Final|Native|Public|BlueprintCallable // @ game+0x4c1f550
	void EndDamage(); // Function Damagers.ShipDamagerComponent.EndDamage // Final|Native|Public|BlueprintCallable // @ game+0x4c1f280
	void BeginDamage(); // Function Damagers.ShipDamagerComponent.BeginDamage // Final|Native|Public|BlueprintCallable // @ game+0x4c1f260
};
...
struct URadialDamagerComponent : UActorComponent {
	...
	void SetDamageRadius(float* Radius); // Function Damagers.RadialDamagerComponent.SetDamageRadius // Final|Native|Public|BlueprintCallable // @ game+0x50a41b0
	void EndDamage(); // Function Damagers.RadialDamagerComponent.EndDamage // Final|Native|Public|BlueprintCallable // @ game+0x50a4020
	void BeginDamage(); // Function Damagers.RadialDamagerComponent.BeginDamage // Final|Native|Public|BlueprintCallable // @ game+0x50a4000
};
...
struct UShockwaveDamagerInterface : UInterface {
	...
	void StartShockwaveAtLocation(struct FVector* StartLocation); // Function Damagers.ShockwaveDamagerInterface.StartShockwaveAtLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x50a4250
	void StartShockwave(); // Function Damagers.ShockwaveDamagerInterface.StartShockwave // Native|Public|BlueprintCallable // @ game+0x50a4230
	void IgnoreGhostShip(struct AAggressiveGhostShip** Ship); // Function Damagers.ShockwaveDamagerInterface.IgnoreGhostShip // Native|Public|BlueprintCallable // @ game+0x50a40a0
	float GetShockwaveRadius(); // Function Damagers.ShockwaveDamagerInterface.GetShockwaveRadius // Native|Public|BlueprintCallable // @ game+0x50a4070
	float GetShockwaveDuration(); // Function Damagers.ShockwaveDamagerInterface.GetShockwaveDuration // Native|Public|BlueprintCallable // @ game+0x50a4040
};
...
struct UShockwaveDamagerComponent : UActorComponent {
	...
	void Multi_StartShockwave(struct FVector* InStartLocation); // Function Damagers.ShockwaveDamagerComponent.Multi_StartShockwave // Final|Net|NetReliableNative|Event|NetMulticast|Private|HasDefaults // @ game+0x50a4130
};

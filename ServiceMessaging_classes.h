...
struct UServiceMessagingFunctions : UBlueprintFunctionLibrary {
	...
	struct FObjectMessagingDispatcherHandle GetServiceMessagingDispatcherFromActor(struct UObject* Object); // Function ServiceMessaging.ServiceMessagingFunctions.GetServiceMessagingDispatcherFromActor // Final|Native|Static|Public|BlueprintCallable // @ game+0x39ccb30
	struct FObjectMessagingDispatcherHandle GetServiceMessagingDispatcher(TScriptInterface<struct UServiceMessagingDispatcherInterface> ServiceMessagingDispatcher); // Function ServiceMessaging.ServiceMessagingFunctions.GetServiceMessagingDispatcher // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x39cca90
};
...
struct UServiceMessagingListenerTestObject : UObject {
	...
	void TestFunctionWithMessage(struct FServiceMessagingTestMessage InMessage); // Function ServiceMessaging.ServiceMessagingListenerTestObject.TestFunctionWithMessage // Final|Native|Public|HasOutParms // @ game+0x39ccbc0
};

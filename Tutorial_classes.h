...
struct UCompanyTutorialVoyageProgress : UObject {
	...
	bool IsSameVoyage(struct FText VoyageName); // Function Tutorial.CompanyTutorialVoyageProgress.IsSameVoyage // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x4af2600
	void AssignVoyage(struct UClass* VoyageProposalDescClass, struct UClass* TaleRankDescClass); // Function Tutorial.CompanyTutorialVoyageProgress.AssignVoyage // Final|Native|Public|BlueprintCallable // @ game+0x4af22e0
};
...
struct UTutorial2019Component : UActorComponent {
	...
	void ReceiveTutorial2019BeginPlayOnServer(); // Function Tutorial.Tutorial2019Component.ReceiveTutorial2019BeginPlayOnServer // Event|Public|BlueprintEvent // @ game+0x1e25660
	void ReceiveTutorial2019BeginPlayOnClient(); // Function Tutorial.Tutorial2019Component.ReceiveTutorial2019BeginPlayOnClient // Event|Public|BlueprintEvent // @ game+0x1e25660
	void OnRep_IsEnabledByServer(bool OldIsEnabled); // Function Tutorial.Tutorial2019Component.OnRep_IsEnabledByServer // Final|Native|Private // @ game+0x4af26b0
	void ForceDisableComponent_Blueprint(); // Function Tutorial.Tutorial2019Component.ForceDisableComponent_Blueprint // Event|Public|BlueprintEvent // @ game+0x1e25660
	void BeginOnServer(); // Function Tutorial.Tutorial2019Component.BeginOnServer // Final|Native|Public|BlueprintCallable // @ game+0x4af23a0
};
...
struct UTutorial2019FunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct FTeleportLocation GetNearestOnboardingSpawnPoint(struct AActor* CharacterToTeleport); // Function Tutorial.Tutorial2019FunctionLibrary.GetNearestOnboardingSpawnPoint // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x4af2470
};
...
struct UTutorialHelpersBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void FirePromptCompleted(struct UClass* AccessKey, struct UObject* WorldContextObject); // Function Tutorial.TutorialHelpersBlueprintLibrary.FirePromptCompleted // Final|Native|Static|Public|BlueprintCallable // @ game+0x4af23c0
};
...
struct UTutorialManager : UActorComponent {
	...
	void OnRep_TutorialType(); // Function Tutorial.TutorialManager.OnRep_TutorialType // Final|Native|Private // @ game+0x4af2760
	void OnRep_SelectedTutorialClass(); // Function Tutorial.TutorialManager.OnRep_SelectedTutorialClass // Final|Native|Private // @ game+0x4af2740
	char GetTutorialType(); // Function Tutorial.TutorialManager.GetTutorialType // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4af2590
};
...
struct UCompanyOnboardingStarter : UTutorialStarter {
	...
	bool HasPrerequisites(); // Function Tutorial.CompanyOnboardingStarter.HasPrerequisites // Native|Event|Protected|BlueprintEvent // @ game+0x4af25d0
};

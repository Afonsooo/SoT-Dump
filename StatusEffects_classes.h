...
struct ULightWeightStatusEffectManagerComponent : UActorComponent {
	...
	void OnRep_ActiveEffects(struct TArray<struct FActiveStatusEffect> OldEffects); // Function StatusEffects.LightWeightStatusEffectManagerComponent.OnRep_ActiveEffects // Final|Native|Private|HasOutParms // @ game+0x3af1cb0
	void MultiCast_ApplyOneShotStatus(struct TArray<struct FActiveStatusEffect> AddedEffects, struct TArray<struct FActiveStatusEffect> RemovedEffects); // Function StatusEffects.LightWeightStatusEffectManagerComponent.MultiCast_ApplyOneShotStatus // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3af1670
};
...
struct UStatusEffectHelperFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void ApplyOneShotStatus(struct AActor* Recipient, struct FStatus Status); // Function StatusEffects.StatusEffectHelperFunctionLibrary.ApplyOneShotStatus // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3af15b0
};
...
struct UStatusEffectManagerComponent : UActorComponent {
	...
	void OnRep_ActiveEffects(struct TArray<struct FActiveStatusEffect> OldEffects); // Function StatusEffects.StatusEffectManagerComponent.OnRep_ActiveEffects // Final|Native|Private|HasOutParms // @ game+0x3af1dd0
	void MultiCast_ApplyOneShotStatus(struct TArray<struct FActiveStatusEffect> AddedEffects, struct TArray<struct FActiveStatusEffect> RemovedEffects); // Function StatusEffects.StatusEffectManagerComponent.MultiCast_ApplyOneShotStatus // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x3af1830
};
...
struct UStatusEffectVolumeComponent : USceneComponent {
	...
	void UnaffectActor(struct AActor* Actor); // Function StatusEffects.StatusEffectVolumeComponent.UnaffectActor // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3af1ef0
	void OnParentComponentEndOverlap(struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function StatusEffects.StatusEffectVolumeComponent.OnParentComponentEndOverlap // Final|Native|Private // @ game+0x3af1bb0
	void OnParentComponentBeginOverlap(struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult SweepResult); // Function StatusEffects.StatusEffectVolumeComponent.OnParentComponentBeginOverlap // Final|Native|Private|HasOutParms // @ game+0x3af19f0
	void AffectActor(struct AActor* Actor); // Function StatusEffects.StatusEffectVolumeComponent.AffectActor // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x3af1530
};

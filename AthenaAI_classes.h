...
struct UAthenaAIFormComponent : UActorComponent {
	...
	void OnRep_FormData(); // Function AthenaAI.AthenaAIFormComponent.OnRep_FormData // Final|Native|Private // @ game+0x4243f20
};
...
struct UAISpawner : UDataAsset {
	...
	int32_t GetNumOfSpawnRequests(); // Function AthenaAI.AISpawner.GetNumOfSpawnRequests // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4243b30
};
...
struct UAIEncounterServiceInterface : UInterface {
	...
	void RegisterLoadedSkillsetProgression(struct UAISkillsetRankProgression** Progression); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedSkillsetProgression // Native|Public|BlueprintCallable // @ game+0x42447e0
	void RegisterLoadedSkillset(struct UAthenaAIControllerParamsDataAsset** Skillset); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedSkillset // Native|Public|BlueprintCallable // @ game+0x4244650
	void RegisterLoadedLoadout(struct ULoadoutAsset** Loadout); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedLoadout // Native|Public|BlueprintCallable // @ game+0x42444c0
	void RegisterLoadedForm(struct UAthenaAIFormDataAsset** Form); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedForm // Native|Public|BlueprintCallable // @ game+0x4244330
	void RegisterLoadedEncounter(struct UAIEncounterSettings** Encounter); // Function AthenaAI.AIEncounterServiceInterface.RegisterLoadedEncounter // Native|Public|BlueprintCallable // @ game+0x42441a0
};
...
struct UAICombatEncounterInterface : UInterface {
	...
	void OnVulnerabilityStateEntered(); // Function AthenaAI.AICombatEncounterInterface.OnVulnerabilityStateEntered // Native|Event|Public|BlueprintEvent // @ game+0x4243fc0
};
...
struct AAIEncounterService : AActor {
	...
	void RegisterLoadedSkillsetProgression(struct UAISkillsetRankProgression* Progression); // Function AthenaAI.AIEncounterService.RegisterLoadedSkillsetProgression // Native|Public|BlueprintCallable // @ game+0x4244710
	void RegisterLoadedSkillset(struct UAthenaAIControllerParamsDataAsset* Skillset); // Function AthenaAI.AIEncounterService.RegisterLoadedSkillset // Native|Public|BlueprintCallable // @ game+0x4244580
	void RegisterLoadedLoadout(struct ULoadoutAsset* Loadout); // Function AthenaAI.AIEncounterService.RegisterLoadedLoadout // Native|Public|BlueprintCallable // @ game+0x42443f0
	void RegisterLoadedForm(struct UAthenaAIFormDataAsset* Form); // Function AthenaAI.AIEncounterService.RegisterLoadedForm // Native|Public|BlueprintCallable // @ game+0x4244260
	void RegisterLoadedEncounter(struct UAIEncounterSettings* Encounter); // Function AthenaAI.AIEncounterService.RegisterLoadedEncounter // Native|Public|BlueprintCallable // @ game+0x42440d0
};
...
struct UAIManagerBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct AItemInfo* SpawnItemFromAI(struct APawn* Pawn, struct UClass* ItemDesc); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.SpawnItemFromAI // Final|Native|Static|Public|BlueprintCallable // @ game+0x4245810
	int32_t GetFrameCounter(); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.GetFrameCounter // Final|Native|Static|Public|BlueprintCallable // @ game+0x4243b00
	void AddNameplateToAIWithLocalisedName(struct AActor* Actor, struct FText DisplayName); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAIWithLocalisedName // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x4243140
	void AddNameplateToAI(struct AActor* Actor, struct FString DisplayName); // Function AthenaAI.AIManagerBlueprintFunctionLibrary.AddNameplateToAI // Final|Native|Static|Public|BlueprintCallable // @ game+0x4243070
};
...
struct UAIManagerServiceInterface : UInterface {
	...
	void StartDespawnAI(struct APawn* AIActor, char DeathType); // Function AthenaAI.AIManagerServiceInterface.StartDespawnAI // Native|Public|BlueprintCallable // @ game+0x42459a0
	int32_t GetNumOfSpawnedPawns(); // Function AthenaAI.AIManagerServiceInterface.GetNumOfSpawnedPawns // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4243b60
};
...
struct AAIManagerService : AActor {
	...
	void TickService(float DeltaSeconds); // Function AthenaAI.AIManagerService.TickService // Final|Native|Public|BlueprintCallable // @ game+0x4245a90
	void StartDespawnAI(struct APawn* AIActor, char DeathType); // Function AthenaAI.AIManagerService.StartDespawnAI // Native|Public|BlueprintCallable // @ game+0x42458d0
};
...
struct UDebugAIManagerServiceInterface : UInterface {
	...
	void SetMaxNumOfSpawnedActors(int32_t InMaxNumOfSpawnedActors); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxNumOfSpawnedActors // Native|Public|BlueprintCallable // @ game+0x42454a0
	void SetMaxAICostUnitsPerRegion(int32_t InMaxAICostUnitsPerRegion); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxAICostUnitsPerRegion // Native|Public|BlueprintCallable // @ game+0x4245390
	void SetMaxAICostUnitsForWorld(int32_t InMaxAICostUnitsForWorld); // Function AthenaAI.DebugAIManagerServiceInterface.SetMaxAICostUnitsForWorld // Native|Public|BlueprintCallable // @ game+0x4245280
	void SetIgnoreCharacterLimits(bool Ignore); // Function AthenaAI.DebugAIManagerServiceInterface.SetIgnoreCharacterLimits // Native|Public|BlueprintCallable // @ game+0x4245050
	void SetDistanceToPlayerToRaiseSpawnPriority(float InDistanceToPlayerToRaiseSpawnPriority); // Function AthenaAI.DebugAIManagerServiceInterface.SetDistanceToPlayerToRaiseSpawnPriority // Native|Public|BlueprintCallable // @ game+0x4244f40
	void SetCharacterWorldDensityCheckTimer(float InCharacterWorldDensityCheckTimer); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterWorldDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4244db0
	void SetCharacterRegionDensityCheckTimer(float InCharacterRegionDensityCheckTimer); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterRegionDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4244cb0
	void SetCharacterNetRelevancy(float InCloseByCharactersRadius); // Function AthenaAI.DebugAIManagerServiceInterface.SetCharacterNetRelevancy // Native|Public|BlueprintCallable // @ game+0x4244bb0
	bool BlockAIAbility(struct UClass* InExclusive, bool InBlockState); // Function AthenaAI.DebugAIManagerServiceInterface.BlockAIAbility // Native|Public|BlueprintCallable // @ game+0x4243480
};
...
struct ADebugAIManagerService : AAIManagerService {
	...
	void SetMaxNumOfSpawnedActors(int32_t InMaxNumOfSpawnedActors); // Function AthenaAI.DebugAIManagerService.SetMaxNumOfSpawnedActors // Native|Public|BlueprintCallable // @ game+0x4245410
	void SetMaxAICostUnitsPerRegion(int32_t InMaxAICostUnitsPerRegion); // Function AthenaAI.DebugAIManagerService.SetMaxAICostUnitsPerRegion // Native|Public|BlueprintCallable // @ game+0x4245300
	void SetMaxAICostUnitsForWorld(int32_t InMaxAICostUnitsForWorld); // Function AthenaAI.DebugAIManagerService.SetMaxAICostUnitsForWorld // Native|Public|BlueprintCallable // @ game+0x42451f0
	void SetIgnoreCharacterLimits(bool Ignore); // Function AthenaAI.DebugAIManagerService.SetIgnoreCharacterLimits // Native|Public|BlueprintCallable // @ game+0x4244fc0
	void SetDistanceToPlayerToRaiseSpawnPriority(float InDistanceToPlayerToRaiseSpawnPriority); // Function AthenaAI.DebugAIManagerService.SetDistanceToPlayerToRaiseSpawnPriority // Native|Public|BlueprintCallable // @ game+0x4244ec0
	void SetCharacterWorldDensityCheckTimer(float InCharacterWorldDensityCheckTimer); // Function AthenaAI.DebugAIManagerService.SetCharacterWorldDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4244d30
	void SetCharacterRegionDensityCheckTimer(float InCharacterRegionDensityCheckTimer); // Function AthenaAI.DebugAIManagerService.SetCharacterRegionDensityCheckTimer // Native|Public|BlueprintCallable // @ game+0x4244c30
	void SetCharacterNetRelevancy(float InCloseByCharactersRadius); // Function AthenaAI.DebugAIManagerService.SetCharacterNetRelevancy // Native|Public|BlueprintCallable // @ game+0x4244b30
	bool BlockAIAbility(struct UClass* InExclusive, bool InBlockState); // Function AthenaAI.DebugAIManagerService.BlockAIAbility // Native|Public|BlueprintCallable // @ game+0x42433b0
};
...
struct UAINameplateComponent : UNameplateComponent {
	...
	void OnRep_Title(); // Function AthenaAI.AINameplateComponent.OnRep_Title // Final|Native|Private // @ game+0x4243f80
	void OnRep_DisplayNameAsString(); // Function AthenaAI.AINameplateComponent.OnRep_DisplayNameAsString // Final|Native|Private // @ game+0x4243f00
	void OnRep_DisplayName(); // Function AthenaAI.AINameplateComponent.OnRep_DisplayName // Final|Native|Private // @ game+0x4243ee0
	void OnRep_DebugDisplayText(); // Function AthenaAI.AINameplateComponent.OnRep_DebugDisplayText // Final|Native|Private // @ game+0x4243ec0
};
...
struct UAIPartsRetrievalComponent : UActorComponent {
	...
	void RequestNewAIParts(struct UAIPartsCategory** AssignedPartsCategory, int32_t* PartsIndexToUse, int32_t* TeamColorIndex); // Function AthenaAI.AIPartsRetrievalComponent.RequestNewAIParts // Final|Native|Public|BlueprintCallable // @ game+0x4244a30
	void OnRep_ReplicatedAIPartsData(); // Function AthenaAI.AIPartsRetrievalComponent.OnRep_ReplicatedAIPartsData // Final|Native|Private // @ game+0x4243f40
};
...
struct UAIFixedWavesSpawner : UAISpawner {
	...
	float EnemyLifetime; // 0x45c(0x04)
	float EnemyLifetimeVariance; // 0x460(0x04)
	char EnemyLifetimeDeathType; // 0x464(0x01)
	char UnknownData_465[0x33]; // 0x465(0x33)
	struct UNamedAIDataAsset* NamedAIDataAsset; // 0x498(0x08)
};
...
struct UAIPerPlayerSpawner : UAISpawner {
	...
	void PlayerDeath(struct AActor** Player); // Function AthenaAI.AIPerPlayerSpawner.PlayerDeath // Final|Native|Public // @ game+0x4243fe0
};
...
struct AAITargetActor : AActor {
	...
	void SetTargetEnabled(bool* InEnabled); // Function AthenaAI.AITargetActor.SetTargetEnabled // Final|Native|Public|BlueprintCallable // @ game+0x4245780
};
...
struct UAITargetWeaponInterface : UInterface {
	...
	bool FindAimConfigToHitTarget(struct FVector* Target, bool* CheckYaw, struct FRotator* OutAimConfig); // Function AthenaAI.AITargetWeaponInterface.FindAimConfigToHitTarget // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x42436d0
};
...
struct AAmbientWaterSpawnerManager : AActor {
	...
	void OnPlayerDeath(struct AActor** InActorDying); // Function AthenaAI.AmbientWaterSpawnerManager.OnPlayerDeath // Final|Native|Private // @ game+0x4243e20
};
...
struct ABurrowCrack : AActor {
	...
	void OnRep_StartFadeAndLifeSpan(); // Function AthenaAI.BurrowCrack.OnRep_StartFadeAndLifeSpan // Final|Native|Public // @ game+0x4243f60
	void OnLifeSpanPercentLeft(float* PercentLeft); // Function AthenaAI.BurrowCrack.OnLifeSpanPercentLeft // Event|Public|BlueprintEvent // @ game+0x1e25660
};
...
struct AAthenaAIControllerBase : AAIController {
	...
	void SetNamedControllerParam(struct FName ParamName, float Value); // Function AthenaAI.AthenaAIControllerBase.SetNamedControllerParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x4245520
	struct FWeightedProbabilityRangeOfRanges FindNamedWeightedRangesControllerParam(struct FName* ParamName); // Function AthenaAI.AthenaAIControllerBase.FindNamedWeightedRangesControllerParam // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x42438c0
	float FindNamedControllerParam(struct FName* ParamName); // Function AthenaAI.AthenaAIControllerBase.FindNamedControllerParam // Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x4243810
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset** ParamsAsset, struct APawn** InPawn); // Function AthenaAI.AthenaAIControllerBase.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x42432e0
};
...
struct AAthenaAIController : AAthenaAIControllerBase {
	...
	void StopBehaviourLogic(); // Function AthenaAI.AthenaAIController.StopBehaviourLogic // Native|Public|BlueprintCallable // @ game+0x4245a70
	void SetPerceptionExpirationAgeForActor(struct AActor* Actor, float ExpirationAge, struct UClass* Sense); // Function AthenaAI.AthenaAIController.SetPerceptionExpirationAgeForActor // Final|Native|Public|BlueprintCallable // @ game+0x4245680
	void RegisterSpawnTriggerActorAsStimulus(struct AActor* TriggerActor); // Function AthenaAI.AthenaAIController.RegisterSpawnTriggerActorAsStimulus // Native|Public|BlueprintCallable // @ game+0x42448a0
	void OnPerceptionUpdated(struct TArray<struct AActor*> ChangedPerceivedActors); // Function AthenaAI.AthenaAIController.OnPerceptionUpdated // Native|Public // @ game+0x4243d20
	void OnNewlySpawned(); // Function AthenaAI.AthenaAIController.OnNewlySpawned // Event|Public|BlueprintEvent // @ game+0x1e25660
	void OnFinishDespawn(); // Function AthenaAI.AthenaAIController.OnFinishDespawn // Event|Public|BlueprintEvent // @ game+0x1e25660
	bool IsActorPerceived(struct AActor* TargetActor); // Function AthenaAI.AthenaAIController.IsActorPerceived // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4243bc0
	struct AActor* GetTargetActor(); // Function AthenaAI.AthenaAIController.GetTargetActor // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4243b90
	struct UAthenaAIPerceptionComponent* GetAthenaAIPerceptionComponent(); // Function AthenaAI.AthenaAIController.GetAthenaAIPerceptionComponent // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x4243ad0
	void GetAllSeenActors(struct TArray<struct AActor*> SeenActors); // Function AthenaAI.AthenaAIController.GetAllSeenActors // Native|Public|HasOutParms|BlueprintCallable // @ game+0x4243a20
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AthenaAI.AthenaAIController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4243210
};
...
struct AAthenaAICharacterController : AAthenaAIController {
	...
	void SetOverridePrioritiseInteractablesBeforeEnemies(bool InPrioritiseInteractablesBeforeEnemies); // Function AthenaAI.AthenaAICharacterController.SetOverridePrioritiseInteractablesBeforeEnemies // Final|Native|Public|BlueprintCallable // @ game+0x42455f0
	void SetItemSpecificNamedControllerParam(struct UClass* InItemCategory, struct FName ParamName, float Value); // Function AthenaAI.AthenaAICharacterController.SetItemSpecificNamedControllerParam // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x42450e0
	void SetDisableTurningForTest(bool InDisableTurningForTest); // Function AthenaAI.AthenaAICharacterController.SetDisableTurningForTest // Final|Native|Public|BlueprintCallable // @ game+0x4244e30
	void ClearOverridePrioritiseInteractablesBeforeEnemies(); // Function AthenaAI.AthenaAICharacterController.ClearOverridePrioritiseInteractablesBeforeEnemies // Final|Native|Public|BlueprintCallable // @ game+0x4243550
};
...
struct UAthenaAIPerceptionComponent : UAIPerceptionComponent {
	...
	bool IsPerceptionSenseEnabled(struct UClass* Sense); // Function AthenaAI.AthenaAIPerceptionComponent.IsPerceptionSenseEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4243c90
	bool IsAnyPerceptionEnabled(); // Function AthenaAI.AthenaAIPerceptionComponent.IsAnyPerceptionEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4243c60
	void EnablePerceptionSense(struct UClass* Sense, bool Enable); // Function AthenaAI.AthenaAIPerceptionComponent.EnablePerceptionSense // Final|Native|Public|BlueprintCallable // @ game+0x4243600
	void EnableAllPerception(bool Enable); // Function AthenaAI.AthenaAIPerceptionComponent.EnableAllPerception // Final|Native|Public|BlueprintCallable // @ game+0x4243570
};
...
struct UCoralShieldVFXComponent : UActorComponent {
	...
	void OnRep_CurrentCoralShieldRole(); // Function AthenaAI.CoralShieldVFXComponent.OnRep_CurrentCoralShieldRole // Final|Native|Private // @ game+0x4243ea0
};
...
// Class AthenaAI.CustomAttitudeComponent
// Size: 0xe0 (Inherited: 0xc8)
struct UCustomAttitudeComponent : UActorComponent {
	char UnknownData_C8[0x8]; // 0xc8(0x08)
	struct TArray<struct UCustomAttitudeRule*> Rules; // 0xd0(0x10)
};

// Class AthenaAI.CustomAttitudeRule
// Size: 0x28 (Inherited: 0x28)
struct UCustomAttitudeRule : UObject {
};

// Class AthenaAI.CrewSpecificCustomAttitudeRule
// Size: 0x58 (Inherited: 0x28)
struct UCrewSpecificCustomAttitudeRule : UCustomAttitudeRule {
	struct FGuid ComparisonCrewId; // 0x28(0x10)
	struct UWorld* WorldContext; // 0x38(0x08)
	bool CheckAlliances; // 0x40(0x01)
	char UnknownData_41[0x17]; // 0x41(0x17)

	void OnRep_WorldContext(); // Function AthenaAI.CrewSpecificCustomAttitudeRule.OnRep_WorldContext // Final|Native|Private // @ game+0x4243fa0
};
...
struct ASpawnContextProviderZone : AActor {
	...
	void RemoveContextsFromTarget(struct AActor** InActor, struct UPrimitiveComponent** InComponent, int32_t* InOtherBodyIndex); // Function AthenaAI.SpawnContextProviderZone.RemoveContextsFromTarget // Final|Native|Private // @ game+0x4244930
	void AddContextsToTarget(struct AActor** InActor, struct UPrimitiveComponent** InComponent, int32_t* InOtherBodyIndex, bool* InFromSweep, struct FHitResult* InSweepResult); // Function AthenaAI.SpawnContextProviderZone.AddContextsToTarget // Final|Native|Private|HasOutParms // @ game+0x4242eb0
};
...
struct UTinySharkLootSpawnParamsDataAsset : UDataAsset {
	...
	char UnknownData_49[0x7]; // 0x49(0x07)
	struct FItemSpawnParams SpawnParams; // 0x50(0x48)
	struct UWeightedItemDescSpawnDataAsset* ReferencedSpawnDistributionAsset; // 0x98(0x08)
	struct TArray<struct FItemSpawnTransform> SpawnTransforms; // 0xa0(0x10)
	struct TArray<struct FItemSpawnTransformWithRandomQuantity> SpawnTransformsWithRandomQuantities; // 0xb0(0x10)
	char SpawnSource; // 0xc0(0x01)
	char UnknownData_C1[0x3]; // 0xc1(0x03)
	float SpawnRate; // 0xc4(0x04)
	bool DestroyProxiesOnEndPlay; // 0xc8(0x01)
	bool SpawnWithPhysicsEnabled; // 0xc9(0x01)
	bool DoNotAttachToOwnerWhenSpawned; // 0xca(0x01)
	bool DropItemsOnSpawn; // 0xcb(0x01)
	bool DropItemsUsingPriorityAIDropParams; // 0xcc(0x01)
...
struct AAICreatureCharacter : ACharacter {
	...
	void SetAIStrategy(struct UClass** InStrategy); // Function AthenaAI.AICreatureCharacter.SetAIStrategy // Native|Public|BlueprintCallable // @ game+0x435db70
	void OnRep_CurrentAIStrategy(struct UClass** OldAIStrategy); // Function AthenaAI.AICreatureCharacter.OnRep_CurrentAIStrategy // Final|Native|Protected // @ game+0x435dad0
	void Multicast_DespawnRPC(); // Function AthenaAI.AICreatureCharacter.Multicast_DespawnRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x435dab0
	struct UClass* GetAIStrategy(); // Function AthenaAI.AICreatureCharacter.GetAIStrategy // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x435d9f0
};
...
struct AAICreatureSpline : AActor {
	...
	void OnRep_ShouldTickBeEnabled(); // Function AthenaAI.AICreatureSpline.OnRep_ShouldTickBeEnabled // Final|Native|Private // @ game+0x435db50
	void OnCreatureMovementStarted(); // Function AthenaAI.AICreatureSpline.OnCreatureMovementStarted // Event|Protected|BlueprintEvent // @ game+0x1e25660
	void OnCreatureMovementCompleted(); // Function AthenaAI.AICreatureSpline.OnCreatureMovementCompleted // Event|Protected|BlueprintEvent // @ game+0x1e25660
	void BeginCreatureMovement(); // Function AthenaAI.AICreatureSpline.BeginCreatureMovement // Final|Native|Protected|BlueprintCallable // @ game+0x435d9d0
};
...
struct ALimitedInteractableAICreatureSpline : AAICreatureSpline {
	...
	void OnInteractionStartedClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionStartedClient // Event|Protected|BlueprintEvent // @ game+0x1e25660
	void OnInteractionCompletedServer(struct AActor** PlayerCharacter); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedServer // Event|Protected|BlueprintEvent // @ game+0x1e25660
	void OnInteractionCompletedClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCompletedClient // Event|Protected|BlueprintEvent // @ game+0x1e25660
	void OnInteractionCancelledClient(); // Function AthenaAI.LimitedInteractableAICreatureSpline.OnInteractionCancelledClient // Event|Protected|BlueprintEvent // @ game+0x1e25660
	void InteractCountRetrieved(int32_t* InInteractedCount); // Function AthenaAI.LimitedInteractableAICreatureSpline.InteractCountRetrieved // Final|Native|Protected|BlueprintCallable // @ game+0x435da30
};
...
struct AAIDebugSpawnActor : AActor {
	...
	void StartSpawning(); // Function AthenaAI.AIDebugSpawnActor.StartSpawning // Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable // @ game+0x43fbdb0
};
...
struct UAthenaAIDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct TArray<struct FAIEncounterSpecification> SpawnMultipleAI(int32_t* Count, struct UAIEncounterSettings** EncounterSettings, struct FVector* Pos, struct FRotator* Rot, float* Delay, bool* MakeAIPermanentlyNetRelevant, struct AActor** InstancedNavMesh); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnMultipleAI // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x43fba90
	void SpawnAIWithSettings(struct UClass** AIType, struct UAthenaAIControllerParamsDataAsset** Skillset, struct ULoadoutAsset** Loadout, struct UAthenaAIFormDataAsset** Form, struct UClass** AIItemSpawnComponent, struct UClass** ClassId, struct UAthenaAIAmmoDataAsset** Ammo, struct FVector* Pos, struct FRotator* Rot, struct FName* Region, struct AActor** TriggerActor, struct FName* NavMeshOverride, float* Delay); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnAIWithSettings // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x43fb3f0
	struct FAIEncounterSpecification SpawnAI(struct UAIEncounterSettings** EncounterSettings, struct FVector* Pos, struct FRotator* Rot, float* Delay, bool* MakeAIPermanentlyNetRelevant, struct AActor** InstancedNavMesh); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SpawnAI // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x43fb0d0
	void SetEnvQueryManagerMaxAllowedSeconds(float* InMaxAllowedSeconds, struct UObject** QueryOwner); // Function AthenaAI.AthenaAIDebugFunctionLibrary.SetEnvQueryManagerMaxAllowedSeconds // Final|Native|Static|Public|BlueprintCallable // @ game+0x43fb010
	void KillAllDebugAISpawners(); // Function AthenaAI.AthenaAIDebugFunctionLibrary.KillAllDebugAISpawners // Final|Native|Static|Public|BlueprintCallable // @ game+0x43faff0
	int32_t GetEnvQueryManagerNumRunningQueries(struct UObject** QueryOwner); // Function AthenaAI.AthenaAIDebugFunctionLibrary.GetEnvQueryManagerNumRunningQueries // Final|Native|Static|Public|BlueprintCallable // @ game+0x43faf70
	void EnableMaximumSightSettings(struct AAthenaAIController** AIController); // Function AthenaAI.AthenaAIDebugFunctionLibrary.EnableMaximumSightSettings // Final|Native|Static|Public|BlueprintCallable // @ game+0x43faf00
	void EnableBehaviorTreeLogging(struct UObject** WorldContext); // Function AthenaAI.AthenaAIDebugFunctionLibrary.EnableBehaviorTreeLogging // Final|Native|Static|Public|BlueprintCallable // @ game+0x43fae90
	void DespawnAIPawn(struct APawn** Pawn); // Function AthenaAI.AthenaAIDebugFunctionLibrary.DespawnAIPawn // Final|Native|Static|Public|BlueprintCallable // @ game+0x43fae20
	void CreateAISpawnerAtPosition(struct UObject** WorldContext, struct UAISpawner** SpawnerAsset, struct FVector* Pos); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtPosition // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x43fad20
	void CreateAISpawnerAtActor(struct UObject** WorldContext, struct UAISpawner** SpawnerAsset, struct AActor** SpawnLocationActor); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CreateAISpawnerAtActor // Final|Native|Static|Public|BlueprintCallable // @ game+0x43fac30
	struct FVector CanProjectPointToNavigation(struct UObject** WorldContext, struct FVector* Point, struct ANavigationData** NavData, struct UClass** FilterClass, struct FVector* QueryExtent); // Function AthenaAI.AthenaAIDebugFunctionLibrary.CanProjectPointToNavigation // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x43faa60
};
...
struct UAIFaunaSpawner : UAISpawner {
	...
	void SpawnFaunaGroup(); // Function AthenaAI.AIFaunaSpawner.SpawnFaunaGroup // Final|Native|Public|BlueprintCallable // @ game+0x45d8e80
};
...
struct AAthenaFaunaAIController : AAthenaAIController {
	...
	void SetDormancyCheckingEnabled(bool InDormancyCheckingEnabledInAutomation); // Function AthenaAI.AthenaFaunaAIController.SetDormancyCheckingEnabled // Final|Native|Public|BlueprintCallable // @ game+0x45d8df0
	void LeaderDestroyed(struct AActor* Actor); // Function AthenaAI.AthenaFaunaAIController.LeaderDestroyed // Final|Native|Private // @ game+0x45d8ab0
	struct AActor* GetLeader(); // Function AthenaAI.AthenaFaunaAIController.GetLeader // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x45d82d0
	float GetCourage(); // Function AthenaAI.AthenaFaunaAIController.GetCourage // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x45d7fd0
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function AthenaAI.AthenaFaunaAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x45d7fa0
};
...
struct AFauna : AAICreatureCharacter {
	...
	float LoseAgitationAdditionalRange; // 0x978(0x04)
	char UnknownData_97C[0x4]; // 0x97c(0x04)
	struct UObject* AgitationResponseParticleSystem; // 0x980(0x08)
	float AgitationResponseRangeParticleSystemAngle; // 0x988(0x04)
	char AgitationCollisionChannel; // 0x98c(0x01)
	bool StopMovementWhenAgitated; // 0x98d(0x01)
	char UnknownData_98E[0x2]; // 0x98e(0x02)
	float ApproximateSpitTravelTime; // 0x990(0x04)
	bool StopMovementWhenCalm; // 0x994(0x01)
	char UnknownData_995[0x3]; // 0x995(0x03)
	float TurningSpringAccelerationDefault; // 0x998(0x04)
	float TurningSpringAccelerationWhenStriking; // 0x99c(0x04)
	float TurningSpringMaxVelocity; // 0x9a0(0x04)
	float TurnResetDelay; // 0x9a4(0x04)
	struct FVector PivotPointOffset; // 0x9a8(0x0c)
	bool ShouldTurn; // 0x9b4(0x01)
	char UnknownData_9B5[0x3]; // 0x9b5(0x03)
	struct UFeedingComponent* FeedingComponent; // 0x9b8(0x08)
	struct UFaunaMovementComponent* FaunaMovementComponent; // 0x9c0(0x08)
	float TimeUntilDrowned; // 0x9c8(0x04)
	int32_t RandomAnimationSeed; // 0x9cc(0x04)
	char UnknownData_9D0[0xc]; // 0x9d0(0x0c)
	bool Drowned; // 0x9dc(0x01)
	char UnknownData_9DD[0x2]; // 0x9dd(0x02)
	char CratedState; // 0x9df(0x01)
	char InWaterState; // 0x9e0(0x01)
	char UnknownData_9E1[0x7]; // 0x9e1(0x07)
	struct AActor* Crate; // 0x9e8(0x08)
	struct UParticleSystemComponent* BreathBubblesParticleSystemComponent; // 0x9f0(0x08)
	float DrowningDeathTime; // 0x9f8(0x04)
	bool IsPlayingStarvingAnim; // 0x9fc(0x01)
	bool IsAgitated; // 0x9fd(0x01)
	bool IsCalm; // 0x9fe(0x01)
	char UnknownData_9FF[0x149]; // 0x9ff(0x149)
	...
	struct AActor* AgitationTarget; // 0xbe0(0x08)
	char UnknownData_BE8[0x8]; // 0xbe8(0x08)

	void TestingSetWaterState(char NewInState); // Function AthenaAI.Fauna.TestingSetWaterState // Final|Native|Public|BlueprintCallable // @ game+0x45d8ea0
	void OnRep_IsPlayingStarvingAnim(); // Function AthenaAI.Fauna.OnRep_IsPlayingStarvingAnim // Final|Native|Private // @ game+0x45d8dd0
	void OnRep_IsCalm(); // Function AthenaAI.Fauna.OnRep_IsCalm // Final|Native|Private // @ game+0x45d8db0
	void OnRep_IsAgitated(); // Function AthenaAI.Fauna.OnRep_IsAgitated // Final|Native|Private // @ game+0x45d8d90
	void OnRep_InWaterState(); // Function AthenaAI.Fauna.OnRep_InWaterState // Final|Native|Private // @ game+0x45d8d70
	void OnRep_CratedState(char PreviousCratedState); // Function AthenaAI.Fauna.OnRep_CratedState // Final|Native|Private|HasOutParms // @ game+0x45d8ce0
	void Multicast_PlayPutInCrateEffectsRPC(struct AActor* Crate); // Function AthenaAI.Fauna.Multicast_PlayPutInCrateEffectsRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x45d8c50
	void Multicast_JustBeenFedRPC(struct AActor* FedBy); // Function AthenaAI.Fauna.Multicast_JustBeenFedRPC // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x45d8bc0
	void Multicast_HightlightLeader(bool bIsLeader); // Function AthenaAI.Fauna.Multicast_HightlightLeader // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x45d8b30
	void GenerateNewRandomAnimationSeed(); // Function AthenaAI.Fauna.GenerateNewRandomAnimationSeed // Final|Native|Public|BlueprintCallable // @ game+0x45d7e30
	void ActivateResponseRPC(struct AActor* Target); // Function AthenaAI.Fauna.ActivateResponseRPC // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x45d7d70
};
...
struct AAthenaSwimmingAIController : AAthenaAIController {
	...
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset** InControllerParametersAsset, struct APawn** InPawn); // Function AthenaAI.AthenaSwimmingAIController.ApplyControllerParams // Final|Native|Public|BlueprintCallable // @ game+0x4abc170
};
...
struct ATinySharkExperience : AActor {
	...
	void TinySharkPawnDestroyed(struct AActor** InDestroyedActor); // Function AthenaAI.TinySharkExperience.TinySharkPawnDestroyed // Final|Native|Private // @ game+0x4ade150
	void OnRep_TinySharkPawn(struct ASharkPawn** LastTinySharkPawn); // Function AthenaAI.TinySharkExperience.OnRep_TinySharkPawn // Native|Protected // @ game+0x4addee0
	struct AShip* GetTrackedShip(); // Function AthenaAI.TinySharkExperience.GetTrackedShip // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4addec0
	char GetCurrentState(); // Function AthenaAI.TinySharkExperience.GetCurrentState // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4addea0
	char GetActiveState(); // Function AthenaAI.TinySharkExperience.GetActiveState // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4adde80
};
...
struct ATinySharkService : AActor {
	...
	bool RequestTinySharkWithShip(struct AShip* InTrackedShip, int32_t OverrideControllerParamIndex, int32_t PartIndex); // Function AthenaAI.TinySharkService.RequestTinySharkWithShip // Native|Public|BlueprintCallable // @ game+0x4ade050
	bool RequestTinySharkWithLocation(struct FVector SpawnLocation, int32_t PartIndex); // Function AthenaAI.TinySharkService.RequestTinySharkWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4addf70
	void DismissAllTinySharks(); // Function AthenaAI.TinySharkService.DismissAllTinySharks // Native|Public|BlueprintCallable // @ game+0x4adde50
	bool CanSpawnTinySharkExperience(); // Function AthenaAI.TinySharkService.CanSpawnTinySharkExperience // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4adde10
};
...
struct APet : AAICreatureCharacter {
	...
	void SetExitTakeOffFlag(bool* InExitTakeOffFlag); // Function AthenaAI.Pet.SetExitTakeOffFlag // Final|Native|Public|BlueprintCallable // @ game+0x4ee7d90
	void OnShipDestroyed(struct AActor** InShip); // Function AthenaAI.Pet.OnShipDestroyed // Final|Native|Public // @ game+0x4ee7c30
	void OnRep_RollRequest(); // Function AthenaAI.Pet.OnRep_RollRequest // Final|Native|Private // @ game+0x4ee7c10
	void OnRep_ResetRollAndZOffset(); // Function AthenaAI.Pet.OnRep_ResetRollAndZOffset // Final|Native|Private // @ game+0x4ee7bf0
	void OnRep_PetTurnToFaceData(); // Function AthenaAI.Pet.OnRep_PetTurnToFaceData // Final|Native|Public // @ game+0x4ee7bd0
	void OnRep_PetOwner(); // Function AthenaAI.Pet.OnRep_PetOwner // Final|Native|Private // @ game+0x4ee7b90
	void OnRep_PetIsSad(); // Function AthenaAI.Pet.OnRep_PetIsSad // Final|Native|Private // @ game+0x4ee7b70
	void OnRep_PetInfo(); // Function AthenaAI.Pet.OnRep_PetInfo // Final|Native|Private // @ game+0x4ee7b50
	void OnRep_PerchedInHangout(); // Function AthenaAI.Pet.OnRep_PerchedInHangout // Final|Native|Private // @ game+0x4ee7b30
	void OnRep_MovementRequest(); // Function AthenaAI.Pet.OnRep_MovementRequest // Final|Native|Private // @ game+0x4ee7b10
	void OnRep_InHangout(); // Function AthenaAI.Pet.OnRep_InHangout // Final|Native|Private // @ game+0x4ee7ad0
	void OnOwnerDestroyed(struct AActor** InOwner); // Function AthenaAI.Pet.OnOwnerDestroyed // Final|Native|Public // @ game+0x4ee78b0
	void Multicast_DitherOut(); // Function AthenaAI.Pet.Multicast_DitherOut // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x4ee7890
	void Multicast_DitherIn(); // Function AthenaAI.Pet.Multicast_DitherIn // Final|Net|NetReliableNative|Event|NetMulticast|Private // @ game+0x4ee7870
	float GetFloorMeshOffsetZ(); // Function AthenaAI.Pet.GetFloorMeshOffsetZ // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ee7850
};

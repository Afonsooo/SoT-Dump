...
struct UNamedChecklistEventActionData : UChecklistActionData {
	...
	struct TArray<struct FString> EventsSource(); // Function ChecklistMaps.NamedChecklistEventActionData.EventsSource // Final|Native|Public|Const // @ game+0x454dc40
};
...
// Size: 0x990 (Inherited: 0x830)
struct AChecklistMap : ATreasureMap {
	int32_t CanvasWidth; // 0x830(0x04)
	int32_t CanvasHeight; // 0x834(0x04)
	struct UFont* Font; // 0x838(0x08)
	float FontScale; // 0x840(0x04)
	float FontLineSpacingScale; // 0x844(0x04)
	char UnknownData_848[0x8]; // 0x848(0x08)
	struct UChecklistMapLayout* ChecklistMapLayout; // 0x850(0x08)
	struct FChecklistMapContents Contents; // 0x858(0xe8)
	char UnknownData_940[0x50]; // 0x940(0x50)

	void RefreshContents(); // Function ChecklistMaps.ChecklistMap.RefreshContents // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x454def0
	void OnTextCanvasUpdate(struct UCanvas** Canvas, int32_t* Width, int32_t* Height); // Function ChecklistMaps.ChecklistMap.OnTextCanvasUpdate // Final|Native|Private // @ game+0x454ddf0
	void OnRep_Contents(struct FChecklistMapContents* InPreviousContents); // Function ChecklistMaps.ChecklistMap.OnRep_Contents // Final|Native|Private|HasOutParms // @ game+0x454dd40
};

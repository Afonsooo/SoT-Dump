...
struct UBurrowHealVFXComponent : UActorComponent {
	...
	void OnRep_IsVFXActive(); // Function AthenaAIAbilities.BurrowHealVFXComponent.OnRep_IsVFXActive // Final|Native|Private // @ game+0x4c90660
};
...
struct UElectricShieldBuffComponent : UActorComponent {
	...
	void OnRep_IsShieldActive(); // Function AthenaAIAbilities.ElectricShieldBuffComponent.OnRep_IsShieldActive // Final|Native|Public // @ game+0x4c90640
	void DeactivateShield(); // Function AthenaAIAbilities.ElectricShieldBuffComponent.DeactivateShield // Native|Public // @ game+0x4c90610
};

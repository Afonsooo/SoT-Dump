...
struct UStoryDrivenBlendedLightingZoneComponent : UBlendedLightingZoneComponent {
	...
	void OnRep_CurrentStoryResponse(); // Function StoryFramework.StoryDrivenBlendedLightingZoneComponent.OnRep_CurrentStoryResponse // Final|Native|Private // @ game+0x1c27050
};
...
struct UStoryDrivenSalvageItemSpawnComponent : USalvageItemSpawnComponent {
	struct FStoryFlag Story; // 0x5d8(0x08)
	char UnknownData_5E8[0x18]; // 0x5e8(0x18)
};
...
struct AStoryService : AActor {
	...
	void OnRep_ActiveStories(); // Function StoryFramework.StoryService.OnRep_ActiveStories // Final|Native|Private // @ game+0x3dc3f10
};

...
struct ABreakableActorBase : AActor {
	...
	void Multicast_WasDefeated(struct AActor** InInstigator, struct AActor** InDirectInstigator); // Function BreakableActorFramework.BreakableActorBase.Multicast_WasDefeated // Net|NetReliableNative|Event|NetMulticast|Protected // @ game+0x4cb3b60
};
...
struct UBreakableActorItemSpawnComponent : UItemSpawnComponent {
	char UnknownData_480[0x80]; // 0x480(0x80)
};

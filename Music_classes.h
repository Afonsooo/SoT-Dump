...
struct UMusicZoneInterface : UEmitterManipulatorInterface {
	...
	bool CanPlayForPlayer(struct AActor* Player); // Function Music.MusicZoneInterface.CanPlayForPlayer // RequiredAPI|Native|Event|Public|BlueprintEvent|Const // @ game+0x4460df0
};
...
struct UMusicZoneComponent : USceneComponent {
	...
	bool SetPlaybackPositionRtpc(float OutTimeInSeconds); // Function Music.MusicZoneComponent.SetPlaybackPositionRtpc // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x4461030
	void OnRep_EmitterRemoteValues(); // Function Music.MusicZoneComponent.OnRep_EmitterRemoteValues // Final|Native|Private // @ game+0x4460ff0
	struct FWwiseEmitter GetEmitter(); // Function Music.MusicZoneComponent.GetEmitter // Native|Public|BlueprintCallable // @ game+0x4460f70
	void DisableZone(); // Function Music.MusicZoneComponent.DisableZone // Final|Native|Public|BlueprintCallable // @ game+0x4460f50
	void Client_StopMusicAndDisableZone(); // Function Music.MusicZoneComponent.Client_StopMusicAndDisableZone // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x4460f30
	void Client_PlayOneShot(int32_t Index); // Function Music.MusicZoneComponent.Client_PlayOneShot // Net|NetReliableNative|Event|NetMulticast|Public|BlueprintCallable // @ game+0x4460eb0
	void Client_ActivateZone(); // Function Music.MusicZoneComponent.Client_ActivateZone // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x4460e90
	void ActivateZone(); // Function Music.MusicZoneComponent.ActivateZone // Final|Native|Public|BlueprintCallable // @ game+0x4460dd0
};
...
struct UAISpawnerMusicZoneComponent : UMusicZoneComponent {
	...
	void OnRep_SpawnerState(); // Function Music.AISpawnerMusicZoneComponent.OnRep_SpawnerState // Final|Native|Private // @ game+0x4461010
};

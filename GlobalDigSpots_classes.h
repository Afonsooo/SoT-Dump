...
struct AGlobalDigSpotService : AActor {
	char UnknownData_3C8[0x8]; // 0x3c8(0x08)
	struct UVoyageDescDataAsset* DefaultVoyageDesc; // 0x3d0(0x08)
	struct UPopUpMessageDesc* Notification; // 0x3d8(0x08)
	struct UGlobalDigSpotDefinitionList* DigSpotDefinitions; // 0x3e0(0x08)
	char UnknownData_3E8[0x10]; // 0x3e8(0x10)
};

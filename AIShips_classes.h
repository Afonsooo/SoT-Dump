...
struct UAIShipContextDescDataAsset : UDataAsset {
	...
	struct TArray<struct FAIShipCrewSizeSpecificSpawnerEntry> CrewSizeSpecificSpawners; // 0x58(0x10)
	struct FAIShipContextDescDamageParams DamageParams; // 0x68(0x14)
	struct FAIShipSailData SailsCustomisation; // 0x7c(0x10)
	struct FColor SailColour; // 0x8c(0x04)
	struct FAIShipCrewFormType FormType; // 0x90(0x20)
	struct FAIShipCrewAmmoType AmmoType; // 0xb0(0x18)
	struct UShortRangeMarkerDataAsset* RewardMarkerParams; // 0xc8(0x08)
	struct TArray<struct UClass*> ItemsToSkip; // 0xd0(0x10)
};
...
struct AShipProxyPawn : APawn {
	struct AActor* Ship; // 0x440(0x08)
	struct AActor* SpawnTargetShip; // 0x448(0x08)
...
struct UAIShipEncounterParamsDataAsset : UDataAsset {
	...
	bool EnableMusicWhenShipsHaveNoTarget; // 0x80(0x01)
	char UnknownData_81[0x3]; // 0x81(0x03)
	int32_t SecondsUntilEncounterEndsAfterLastCrewLeft; // 0x84(0x04)
	int32_t MaximumEncounterDuration; // 0x88(0x04)
	float OnDemandAvailabilityRadius; // 0x8c(0x04)
};
...
struct UAIShipServiceDataAsset : UDataAsset {
	...
	struct FIntPoint ObstacleBucketDimensions; // 0x88(0x08)
	float ShipwreckObstacleRadius; // 0x90(0x04)
	...
	float TimerBattleFinderThrottle; // 0x218(0x04)
	char UnknownData_21C[0x4]; // 0x21c(0x04)
	struct FWeightedProbabilityRangeOfRanges TimerBattleRetryRegenInterval; // 0x220(0x30)
	float TimerBattleMinActivationDistanceFromPlayers; // 0x250(0x04)
	char UnknownData_254[0x4]; // 0x254(0x04)
	struct UShortRangeMarkerDataAsset* RewardMarkerParams; // 0x258(0x08)
	struct TArray<struct FName> IslandsToAvoid; // 0x260(0x10)
	float AvoidanceRange; // 0x270(0x04)
...
struct UAIShipDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void RequestAIShipForCrew(struct UObject** WorldContextObject, struct FGuid* CrewId); // Function AIShips.AIShipDebugFunctionLibrary.RequestAIShipForCrew // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x4a9f760
	struct FAIShipEncounterBattleDesc GenerateAIShipBattleDesc(struct UObject** WorldContextObject, struct UAIShipServiceDataAsset** ServiceParams); // Function AIShips.AIShipDebugFunctionLibrary.GenerateAIShipBattleDesc // Final|Native|Static|Public|BlueprintCallable // @ game+0x4a9f620
};

// Class AIShips.AIShipGameSettings
// Size: 0x60 (Inherited: 0x38)
struct UAIShipGameSettings : UDeveloperSettings {
...
struct UAIShipsBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool RequestPassiveAIShipForPlayerShip(struct UObject** WorldContext, struct AActor** PlayerShip, struct UClass** ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestPassiveAIShipForPlayerShip // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x4a9fbb0
	bool RequestPassiveAIShipAtLocation(struct UObject** WorldContext, struct FVector* Location, struct AActor** PlayerShip, struct UClass** ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestPassiveAIShipAtLocation // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4a9fa60
	bool RequestAggressiveAIShipForPlayerShip(struct UObject** WorldContext, struct AActor** PlayerShip, struct UClass** ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestAggressiveAIShipForPlayerShip // Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable // @ game+0x4a9f970
	bool RequestAggressiveAIShipAtLocation(struct UObject** WorldContext, struct FVector* Location, struct AActor** PlayerShip, struct UClass** ForcedAIShipSize); // Function AIShips.AIShipsBlueprintFunctionLibrary.RequestAggressiveAIShipAtLocation // Final|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4a9f820
};

// Class AIShips.AIShipService
// Size: 0x7f8 (Inherited: 0x3c8)
struct AAIShipService : AActor {
	...
	struct UAIShipServiceDataAsset* Params; // 0x3f8(0x08)
	char UnknownData_400[0x3f8]; // 0x400(0x3f8)
};
...
struct AAthenaAIShipController : AAthenaAIControllerBase {
	...
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset** ParamsAsset, struct APawn** InPawn); // Function AIShips.AthenaAIShipController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x4a9f550
};
...
struct UCursedCrewCustomisationInterface : UInterface {
	...
	void SetCursedCrewCustomisationProperties(struct FAIShipSailData* SailData); // Function AIShips.CursedCrewCustomisationInterface.SetCursedCrewCustomisationProperties // Native|Event|Public|HasOutParms|BlueprintEvent // @ game+0x4a9fca0
};

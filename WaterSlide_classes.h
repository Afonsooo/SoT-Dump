...
struct AWaterSlide : ARide {
	...
	void SetEntranceCollisionComponent(struct UPrimitiveComponent* InEntranceCollisionComponent); // Function WaterSlide.WaterSlide.SetEntranceCollisionComponent // Final|Native|Protected|BlueprintCallable // @ game+0x505af00
	void ComponentBeginOverlapCallBack(struct AActor* InOtherActor, struct UPrimitiveComponent* InOtherComp, int32_t InOtherBodyIndex, bool InFromSweep, struct FHitResult InSweepResult); // Function WaterSlide.WaterSlide.ComponentBeginOverlapCallBack // Final|Native|Private|HasOutParms // @ game+0x505ad40
};

// Class WaterSlide.Zipline
// Size: 0x770 (Inherited: 0x3e0)
struct AZipline : ARide {
	...
	struct FPlayerStat PlayerAttachStat; // 0x760(0x04)
	char UnknownData_764[0xc]; // 0x764(0x0c)
};

// Class WaterSlide.InteractableZipline
// Size: 0x790 (Inherited: 0x770)
struct AInteractableZipline : AZipline {
	struct UInteractableComponentWithActionRules* ZiplineStartInteractionPoint; // 0x770(0x08)
	struct UInteractableComponentWithActionRules* ZiplineEndInteractionPoint; // 0x778(0x08)
	struct UClass* PressedNotificationInputId; // 0x780(0x08)

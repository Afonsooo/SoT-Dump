...
struct UWhileBlackboardKeySetAIGoal : UAIGoal {
	...
	struct TArray<struct FString> GetAllowedBlackboardKeys(); // Function AIGoals.WhileBlackboardKeySetAIGoal.GetAllowedBlackboardKeys // Final|Native|Private|Const // @ game+0x7040a0
};

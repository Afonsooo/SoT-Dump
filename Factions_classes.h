...
// Size: 0x8a0 (Inherited: 0x630)
struct UFactionFlipMeshComponent : UStaticMeshComponent {
	struct UCurveFloat* FlipCurve; // 0x630(0x08)
	struct UClass* FlippedFaction; // 0x638(0x08)
	float FactionJoinedLerpDuration; // 0x640(0x04)
	char UnknownData_644[0x244]; // 0x644(0x244)
	struct FGuid OwningShipCrewId; // 0x888(0x10)
	int32_t OwningShipCrewStreak; // 0x898(0x04)
	bool ServerTargetFlipped; // 0x89c(0x01)
	char UnknownData_89D[0x3]; // 0x89d(0x03)

	void OnRep_Streak(); // Function Factions.FactionFlipMeshComponent.OnRep_Streak // Final|Native|Public // @ game+0x50d4630
	void OnRep_ServerTargetFlipped(); // Function Factions.FactionFlipMeshComponent.OnRep_ServerTargetFlipped // Final|Native|Public // @ game+0x50d4610
};
...
// Size: 0xa60 (Inherited: 0x8c0)
struct UFactionParticleComponent : UParticleSystemComponent {
	char UnknownData_8C0[0x178]; // 0x8c0(0x178)
	struct UClass* Faction; // 0xa38(0x08)
	struct UClass* JoinedFaction; // 0xa40(0x08)
	struct FGuid OwningShipCrewId; // 0xa48(0x10)
	int32_t OwningShipCrewStreak; // 0xa58(0x04)
	bool ServerMigrationEnded; // 0xa5c(0x01)
	char UnknownData_A5D[0x3]; // 0xa5d(0x03)

	void OnRep_Streak(); // Function Factions.FactionParticleComponent.OnRep_Streak // Final|Native|Public // @ game+0x50d4650
	void OnRep_ServerMigrationEnded(); // Function Factions.FactionParticleComponent.OnRep_ServerMigrationEnded // Final|Native|Public // @ game+0x50d45f0
};
...
struct AFactionService : AActor {
	...
	void OnRep_FactionAlignedCrews(struct TArray<struct FCrewFactionEntry>* PreviousCrews); // Function Factions.FactionService.OnRep_FactionAlignedCrews // Final|Native|Public|HasOutParms // @ game+0x50d4520
};
...
struct UFactionVoteConsumerBase : UVoteConsumerInlineBase {
	...
	void OnRep_Votes(struct TArray<struct FCrewMemberVotes>* PreviousVotes); // Function Factions.FactionVoteConsumerBase.OnRep_Votes // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x50d4670
};
...
struct UFactionVoteValidatorBase : UVoteValidatorInlineBase {
	...
	void OnRep_CurrentCompany(); // Function Factions.FactionVoteValidatorBase.OnRep_CurrentCompany // Final|Native|Protected // @ game+0x50d4500
};
...
struct UShipFactionCustomisation : UActorComponent {
	...
	void OnRep_FactionStreakData(); // Function Factions.ShipFactionCustomisation.OnRep_FactionStreakData // Final|Native|Private // @ game+0x50d45d0
};

// Enum AthenaEngine.EAdaptiveTrigger
enum class EAdaptiveTrigger : uint8_t {
	None,
	None,
	None,
	None,
...
// ScriptStruct AthenaEngine.AdaptiveTriggerEffectMode_Vibration
// Size: 0x04 (Inherited: 0x00)
struct FAdaptiveTriggerEffectMode_Vibration {
	char Position; // 0x00(0x01)
	char Frequency; // 0x01(0x01)
	char Amplitude; // 0x02(0x01)
	bool UseTriggerEffectForThreshold; // 0x03(0x01)
};
...
// ScriptStruct AthenaEngine.AdaptiveTriggerEffectMode_Off
// Size: 0x01 (Inherited: 0x00)
struct FAdaptiveTriggerEffectMode_Off {
	char UnknownData_0[0x1]; // 0x00(0x01)
};

// ScriptStruct AthenaEngine.AdaptiveTriggerEffectMode_Feedback
// Size: 0x03 (Inherited: 0x00)
struct FAdaptiveTriggerEffectMode_Feedback {
	char Position; // 0x00(0x01)
	char Strength; // 0x01(0x01)
	bool UseTriggerEffectForThreshold; // 0x02(0x01)
};

// ScriptStruct AthenaEngine.AdaptiveTriggerEffectMode_Weapon
// Size: 0x04 (Inherited: 0x00)
struct FAdaptiveTriggerEffectMode_Weapon {
	char StartPosition; // 0x00(0x01)
	char EndPosition; // 0x01(0x01)

...
// ScriptStruct FireworkFramework.FireworkSequentialSelectionType
// Size: 0x08 (Inherited: 0x00)
struct FFireworkSequentialSelectionType {
	int32_t SelectionIndex; // 0x00(0x04)
	float TimeUntilNextExplosion; // 0x04(0x04)
};

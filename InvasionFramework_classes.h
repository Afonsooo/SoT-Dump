...
struct UInvasionServiceInterface : UInterface {
	...
	struct FName GetCachedFactionIdentifierForMatchmakingCrew(struct FGuid InCrewId); // Function InvasionFramework.InvasionServiceInterface.GetCachedFactionIdentifierForMatchmakingCrew // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x45867f0
	struct FName GetCachedFactionIdentifierForInvadingCrew(struct FGuid InCrewId); // Function InvasionFramework.InvasionServiceInterface.GetCachedFactionIdentifierForInvadingCrew // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4586740
	bool GetAggressivePassiveInvasionTargetLocationOffset(struct FGuid InCrewId, struct FVector OutTargetLocation); // Function InvasionFramework.InvasionServiceInterface.GetAggressivePassiveInvasionTargetLocationOffset // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4586640
	bool GetAggressivePassiveInvasionResurfaceDistanceForCrewId(struct FGuid InCrewId, float OutMinDistance, float OutMaxDistance); // Function InvasionFramework.InvasionServiceInterface.GetAggressivePassiveInvasionResurfaceDistanceForCrewId // Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4586500
};
...
struct AInvasionBattleBounds : AActor {
	...
	void OnRep_InnerRadius(); // Function InvasionFramework.InvasionBattleBounds.OnRep_InnerRadius // Final|Native|Private // @ game+0x4c09ed0
	void Multicast_ExplodeShip(struct AActor* Ship); // Function InvasionFramework.InvasionBattleBounds.Multicast_ExplodeShip // Net|NetReliableNative|Event|NetMulticast|Public // @ game+0x4c09e50
};
...
struct UInvasionBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool ShouldAggressivePassiveTeleportUseEQS(); // Function InvasionFramework.InvasionBlueprintFunctionLibrary.ShouldAggressivePassiveTeleportUseEQS // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x4c09fa0
	float GetAggressivePassiveTeleportOffsetDistance(); // Function InvasionFramework.InvasionBlueprintFunctionLibrary.GetAggressivePassiveTeleportOffsetDistance // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x4c09e20
};
...
struct AInvasionService : AActor {
	...
	void OnRep_ReplicatedInvasionCrewMusicStates(struct TArray<struct FReplicatedInvasionCrewMusicState> StaleMusicStates); // Function InvasionFramework.InvasionService.OnRep_ReplicatedInvasionCrewMusicStates // Final|Native|Private|HasOutParms // @ game+0x4c09ef0
};

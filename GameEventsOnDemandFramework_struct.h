// Enum GameEventsOnDemandFramework.EGameEventOnDemandCompletedState
enum class EGameEventOnDemandCompletedState : uint8_t {
	None,
	None,
	None,
	None,
...
// ScriptStruct GameEventsOnDemandFramework.GameEventOnDemandFailedTelemetryEvent
// Size: 0x10 (Inherited: 0x00)
struct FGameEventOnDemandFailedTelemetryEvent {
	struct TArray<struct FGuid> ParticipatingOnDemandCrews; // 0x00(0x10)
};

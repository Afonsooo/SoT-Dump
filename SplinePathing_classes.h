...
struct AFixedSplinePathingActor : AActor {
	...
	void SetSplineActor(struct AActor** Actor); // Function SplinePathing.FixedSplinePathingActor.SetSplineActor // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x464dc30
	void OnRep_SplineActor(); // Function SplinePathing.FixedSplinePathingActor.OnRep_SplineActor // Final|Native|Private // @ game+0x464dc10
	void OnRep_CanTick(); // Function SplinePathing.FixedSplinePathingActor.OnRep_CanTick // Final|RequiredAPI|Native|Private // @ game+0x464dbf0
};

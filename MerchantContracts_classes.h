// Class MerchantContracts.DoesWieldedItemSatisfyMerchantContractStatCondition
// Size: 0x28 (Inherited: 0x28)
struct UDoesWieldedItemSatisfyMerchantContractStatCondition : UStatCondition {
};
...
struct UMerchantContractsBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	struct FText GetDateFromTimeLimit(TScriptInterface<struct UGameServiceProviderInterface>* ServiceProviderInterface, float* TimeLimit); // Function MerchantContracts.MerchantContractsBlueprintLibrary.GetDateFromTimeLimit // Final|Native|Static|Public|BlueprintCallable // @ game+0x45e4e30
};

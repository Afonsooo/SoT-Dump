...
struct APetAIController : AAthenaAIController {
	...
	void OnPerceptionUpdated(struct TArray<struct AActor*>* ChangedPerceivedActors); // Function Pets.PetAIController.OnPerceptionUpdated // Native|Public // @ game+0x4ee7930
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function Pets.PetAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4ee7820
};
...
struct UPetHangoutSpotComponent : USceneComponent {
	...
	void OnRep_IsOwnerSinking(); // Function Pets.PetHangoutSpotComponent.OnRep_IsOwnerSinking // Final|Native|Private // @ game+0x4ee7af0
};
...
struct APetItemInfo : ANonStorableItemInfo {
	...
	void OnRep_PetOwner(); // Function Pets.PetItemInfo.OnRep_PetOwner // Final|Native|Private // @ game+0x4ee7bb0
};
...
struct UPetOwnerComponent : UActorComponent {
	...
	void Server_RequestDismissal(); // Function Pets.PetOwnerComponent.Server_RequestDismissal // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x4ee7d40
};
...
struct UPetsService : UObject {
	...
	void RemovePetFromActor(struct AActor** InOwner); // Function Pets.PetsService.RemovePetFromActor // Final|Native|Public|BlueprintCallable // @ game+0x4ee7cb0
	void AddPetForActorAndWield(struct UClass** InPetType, struct FPetCustomisation* InCustomisation, struct AActor** InOwner, bool* IsWielded); // Function Pets.PetsService.AddPetForActorAndWield // Native|Public|BlueprintCallable // @ game+0x4ee7680
	void AddPetForActor(struct UClass** InPetType, struct FPetCustomisation* InCustomisation, struct AActor** InOwner); // Function Pets.PetsService.AddPetForActor // Final|Native|Public|BlueprintCallable // @ game+0x4ee7510
};
...
// Size: 0x940 (Inherited: 0x7f0)
struct AWieldablePet : ASkeletalMeshWieldableItem {
	char UnknownData_7F0[0x30]; // 0x7f0(0x30)
	float ThirdPersonScalingModifier; // 0x820(0x04)
	char UnknownData_824[0x4]; // 0x824(0x04)
	struct UWieldablePetComponent* WieldablePetComponent; // 0x828(0x08)
	struct UAIPartsRetrievalComponent* AIPartsRetrievalComponent; // 0x830(0x08)
	struct UPetPartCustomisationComponent* PetPartCustomisationComponent; // 0x838(0x08)
	struct UAnimNotifyWwiseEmitterComponent* AnimNotifyWwiseEmitterComponent; // 0x840(0x08)
	struct UWaterExposureComponent* WaterExposureComponent; // 0x848(0x08)
	struct UUsableWieldableComponent* UsableWieldableComponent; // 0x850(0x08)
	struct UPickupableComponent* PickupableComponent; // 0x858(0x08)
	struct UWieldableInteractableComponent* WieldableInteractableComponent; // 0x860(0x08)
	struct UCleanlinessComponent* CleanlinessComponent; // 0x868(0x08)
	struct ULightWeightStatusEffectManagerComponent* LightWeightStatusEffectManagerComponent; // 0x870(0x08)
	struct UPetDitherComponent* PetDitherComponent; // 0x878(0x08)
	struct AActor* PetOwner; // 0x880(0x08)
	struct UFeedingComponent* FeedingComponent; // 0x888(0x08)
	struct UPetSicknessComponent* SicknessComponent; // 0x890(0x08)
	struct UWieldablePetHungerComponent* HungerComponent; // 0x898(0x08)
	struct UStarvingComponent* StarvingComponent; // 0x8a0(0x08)
	struct UPetTelemetryComponent* TelemetryComponent; // 0x8a8(0x08)
	struct UAnimationDataStoreComponent* AnimationDataStoreComponent; // 0x8b0(0x08)
	bool SubmergedStrokingEnabled; // 0x8b8(0x01)
	char UnknownData_8B9[0x6f]; // 0x8b9(0x6f)
	char HungerReactAnimationState; // 0x928(0x01)
	char DropRequest; // 0x929(0x01)
	char UnknownData_92A[0x16]; // 0x92a(0x16)

	void OnRep_HungerReactAnimationState(); // Function Pets.WieldablePet.OnRep_HungerReactAnimationState // Final|Native|Private // @ game+0x4ee7ab0
	void OnRep_DropRequest(char PriorDropRequest); // Function Pets.WieldablePet.OnRep_DropRequest // Final|Native|Private // @ game+0x4ee7a30
};

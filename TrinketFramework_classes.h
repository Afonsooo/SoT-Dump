...
struct ATrinketReplacementActor : AActor {
	...
	void RegisterTrinketReplacementMesh(struct AActor** ActorWithTrinkets, struct UStaticMeshComponent** ReplacementMesh); // Function TrinketFramework.TrinketReplacementActor.RegisterTrinketReplacementMesh // Final|Native|Public|BlueprintCallable // @ game+0x3f992c0
};
